...
/** Initializes a new instance of the GeolocationClientImpl type. */
@ServiceClient(builder = GeolocationClientBuilder.class)
public final class GeolocationClientImpl implements GeolocationClient {
    ...
    /** The GeolocationsClient object to access its operations. */
    private final GeolocationsClient geolocations;

    /**
     * Gets the GeolocationsClient object to access its operations.
     *
     * @return the GeolocationsClient object.
     */
    public GeolocationsClient getGeolocations() {
    ...
    GeolocationClientImpl(
        ...
        this.apiVersion = "1.0";
        this.geolocations = new GeolocationsClientImpl(this);
    }
