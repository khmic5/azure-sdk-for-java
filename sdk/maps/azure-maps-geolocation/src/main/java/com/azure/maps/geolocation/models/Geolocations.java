...
/** Resource collection API of Geolocations. */
public interface Geolocations {
     ...
     */
    IpAddressToLocationResult getIpToLocationPreview(ResponseFormat format, String ip);
     ...
     * @return this object is returned from a successful call to IP Address to country/region API.
     */
    Response<IpAddressToLocationResult> getIpToLocationPreviewWithResponse(
