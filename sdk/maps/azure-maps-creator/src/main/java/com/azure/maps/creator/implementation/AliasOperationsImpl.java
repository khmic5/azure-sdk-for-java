...
import com.azure.maps.creator.models.AliasListResult;
import com.azure.maps.creator.models.ErrorResponseException;
import com.azure.maps.creator.models.Geography;
import reactor.core.publisher.Mono;

/** An instance of this class provides access to all the operations defined in AliasOperations. */
public final class AliasOperationsImpl {
    private final ClientLogger logger = new ClientLogger(AliasOperationsImpl.class);
    ...
    /**
     * Initializes an instance of AliasOperationsImpl.
     *
     * @param client the instance of the service client containing this operation class.
     */
    AliasOperationsImpl(CreatorClientImpl client) {
        this.service = RestProxy.create(AliasService.class, client.getHttpPipeline(), client.getSerializerAdapter());
        this.client = client;
    }

    /**
     * The interface defining all the services for CreatorClientAliasOperations to be used by the proxy service to
     * perform REST calls.
     */
    @Host("https://{geography}.atlas.microsoft.com")
    @ServiceInterface(name = "CreatorClientAliasOp")
    private interface AliasService {
        ...
        @UnexpectedResponseExceptionType(ErrorResponseException.class)
        Mono<Response<AliasListResult>> list(
                @HostParam("geography") Geography geography,
                @HeaderParam("x-ms-client-id") String clientId,
                @QueryParam("api-version") String apiVersion,
                @HeaderParam("Accept") String accept,
        ...
        @ExpectedResponses({200})
        @UnexpectedResponseExceptionType(ErrorResponseException.class)
        Mono<Response<AliasListResult>> listNext(
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Mono<AliasCreateResponse> createWithResponseAsync(String creatorDataItemId, Context context) {
        final String apiVersion = "2.0";
        final String accept = "application/json";
        return service.create(
                this.client.getGeography(), this.client.getClientId(), apiVersion, creatorDataItemId, accept, context);
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Mono<Alias> createAsync(String creatorDataItemId) {
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Mono<Alias> createAsync(String creatorDataItemId, Context context) {
        return createWithResponseAsync(creatorDataItemId, context)
                .flatMap(
                        (AliasCreateResponse res) -> {
                            if (res.getValue() != null) {
                                return Mono.just(res.getValue());
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Alias create(String creatorDataItemId) {
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public AliasCreateResponse createWithResponse(String creatorDataItemId, Context context) {
        return createWithResponseAsync(creatorDataItemId, context).block();
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Mono<PagedResponse<Alias>> listSinglePageAsync() {
        final String apiVersion = "2.0";
        final String accept = "application/json";
        return FluxUtil.withContext(
                        context ->
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Mono<PagedResponse<Alias>> listSinglePageAsync(Context context) {
        final String apiVersion = "2.0";
        final String accept = "application/json";
    ...
    public PagedFlux<Alias> listAsync() {
     ...
     */
    @ServiceMethod(returns = ReturnType.COLLECTION)
    public PagedFlux<Alias> listAsync(Context context) {
     ...
     */
    @ServiceMethod(returns = ReturnType.COLLECTION)
    public PagedIterable<Alias> list(Context context) {
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Mono<Response<Alias>> assignWithResponseAsync(String aliasId, String creatorDataItemId) {
        final String apiVersion = "2.0";
        final String accept = "application/json";
        return FluxUtil.withContext(
                context ->
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Mono<Response<Alias>> assignWithResponseAsync(String aliasId, String creatorDataItemId, Context context) {
        final String apiVersion = "2.0";
        final String accept = "application/json";
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Mono<Alias> assignAsync(String aliasId, String creatorDataItemId) {
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Mono<Alias> assignAsync(String aliasId, String creatorDataItemId, Context context) {
        return assignWithResponseAsync(aliasId, creatorDataItemId, context)
                .flatMap(
                        (Response<Alias> res) -> {
                            if (res.getValue() != null) {
                                return Mono.just(res.getValue());
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Alias assign(String aliasId, String creatorDataItemId) {
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Response<Alias> assignWithResponse(String aliasId, String creatorDataItemId, Context context) {
        return assignWithResponseAsync(aliasId, creatorDataItemId, context).block();
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Mono<Response<Void>> deleteWithResponseAsync(String aliasId, Context context) {
        final String apiVersion = "2.0";
        final String accept = "application/json";
        return service.delete(
                this.client.getGeography(), this.client.getClientId(), aliasId, apiVersion, accept, context);
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Mono<Void> deleteAsync(String aliasId, Context context) {
        return deleteWithResponseAsync(aliasId, context).flatMap((Response<Void> res) -> Mono.empty());
    }
    ...
    public Response<Void> deleteWithResponse(String aliasId, Context context) {
        return deleteWithResponseAsync(aliasId, context).block();
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Mono<Response<Alias>> getWithResponseAsync(String aliasId) {
        final String apiVersion = "2.0";
        final String accept = "application/json";
        return FluxUtil.withContext(
                context ->
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Mono<Response<Alias>> getWithResponseAsync(String aliasId, Context context) {
        final String apiVersion = "2.0";
        final String accept = "application/json";
        return service.get(this.client.getGeography(), this.client.getClientId(), aliasId, apiVersion, accept, context);
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Mono<Alias> getAsync(String aliasId) {
        return getWithResponseAsync(aliasId)
                .flatMap(
                        (Response<Alias> res) -> {
                            if (res.getValue() != null) {
                                return Mono.just(res.getValue());
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Mono<Alias> getAsync(String aliasId, Context context) {
        return getWithResponseAsync(aliasId, context)
                .flatMap(
                        (Response<Alias> res) -> {
                            if (res.getValue() != null) {
                                return Mono.just(res.getValue());
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Alias get(String aliasId) {
        return getAsync(aliasId).block();
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Response<Alias> getWithResponse(String aliasId, Context context) {
        return getWithResponseAsync(aliasId, context).block();
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Mono<PagedResponse<Alias>> listNextSinglePageAsync(String nextLink) {
        final String accept = "application/json";
        return FluxUtil.withContext(
                        context ->
                                service.listNext(
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Mono<PagedResponse<Alias>> listNextSinglePageAsync(String nextLink, Context context) {
        final String accept = "application/json";
