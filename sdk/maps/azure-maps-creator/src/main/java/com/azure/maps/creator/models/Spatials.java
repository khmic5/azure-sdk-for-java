...
/** Resource collection API of Spatials. */
public interface Spatials {
     ...
     */
    GeofenceResponse getGeofence(ResponseFormat format, String deviceId, String udid, float latitude, float longitude);
     ...
     * @return this object is returned from a geofence proximity call.
     */
    Response<GeofenceResponse> getGeofenceWithResponse(
     ...
     * @return this object is returned from a geofence proximity call.
     */
    Response<GeofenceResponse> postGeofenceWithResponse(
        ResponseFormat format,
        String deviceId,
        float latitude,
        float longitude,
     ...
     */
    BufferResponse postBuffer(ResponseFormat format, BufferRequestBody bufferRequestBody);
     ...
     * @return this object is returned from a successful Spatial Buffer call.
     */
    Response<BufferResponse> postBufferWithResponse(
     ...
     * @return this object is returned from a successful Spatial Buffer call.
     */
    BufferResponse getBuffer(ResponseFormat format, String udid, String distances);
     ...
     * @return this object is returned from a successful Spatial Buffer call.
     */
    Response<BufferResponse> getBufferWithResponse(
     ...
     */
    ClosestPointResponse postClosestPoint(
     ...
     * @return this object is returned from a successful Spatial Closest Point call.
     */
    Response<ClosestPointResponse> postClosestPointWithResponse(
        ResponseFormat format,
        float latitude,
        float longitude,
     ...
     * @return this object is returned from a successful Spatial Closest Point call.
     */
    ClosestPointResponse getClosestPoint(ResponseFormat format, String udid, float latitude, float longitude);
     ...
     * @return this object is returned from a successful Spatial Closest Point call.
     */
    Response<ClosestPointResponse> getClosestPointWithResponse(
        ResponseFormat format,
        String udid,
        float latitude,
        float longitude,
     ...
     */
    PointInPolygonResponse postPointInPolygon(
     ...
     * @return returns true if point is within the polygon, false otherwise.
     */
    Response<PointInPolygonResponse> postPointInPolygonWithResponse(
        ResponseFormat format,
        float latitude,
        float longitude,
     ...
     * @return returns true if point is within the polygon, false otherwise.
     */
    PointInPolygonResponse getPointInPolygon(ResponseFormat format, String udid, float latitude, float longitude);
     ...
     * @return returns true if point is within the polygon, false otherwise.
     */
    Response<PointInPolygonResponse> getPointInPolygonWithResponse(
     ...
     */
    GreatCircleDistanceResponse getGreatCircleDistance(ResponseFormat format, String query);
     ...
     * @return this object is returned from a successful Great Circle Distance call.
     */
    Response<GreatCircleDistanceResponse> getGreatCircleDistanceWithResponse(
