...
/** Resource collection API of Tilesets. */
public interface Tilesets {
     ...
     */
    LongRunningOperationResult create(String datasetId, String description);
     ...
     * @return the response model for a Long-Running Operations API.
     */
    LongRunningOperationResult create(String datasetId);
     ...
     * @return the response model for a Long-Running Operations API.
     */
    LongRunningOperationResult create(String datasetId, String description, Context context);
     ...
     */
    PagedIterable<TilesetDetailInfo> list();
     ...
     * @return the response model for the Tileset List API.
     */
    PagedIterable<TilesetDetailInfo> list(Context context);
     ...
     */
    TilesetDetailInfo get(String tilesetId);
     ...
     * @return detail information for the data.
     */
    Response<TilesetDetailInfo> getWithResponse(String tilesetId, Context context);
