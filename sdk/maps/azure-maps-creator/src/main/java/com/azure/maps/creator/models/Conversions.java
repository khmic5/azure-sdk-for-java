...
/** Resource collection API of Conversions. */
public interface Conversions {
     ...
     */
    LongRunningOperationResult convert(String udid, String outputOntology, String description);
     ...
     * @return the response model for a Long-Running Operations API.
     */
    LongRunningOperationResult convert(String udid, String outputOntology);
     ...
     * @return the response model for a Long-Running Operations API.
     */
    LongRunningOperationResult convert(String udid, String outputOntology, String description, Context context);
     ...
     */
    PagedIterable<ConversionListDetailInfo> list();
     ...
     * @return the response model for the Conversion List API.
     */
    PagedIterable<ConversionListDetailInfo> list(Context context);
     ...
     */
    ConversionListDetailInfo get(String conversionId);
     ...
     * @return detail information for the conversion requests.
     */
    Response<ConversionListDetailInfo> getWithResponse(String conversionId, Context context);
     ...
     * @return the response model for a Long-Running Operations API.
     */
    LongRunningOperationResult getOperation(String operationId);
     ...
     * @return the response model for a Long-Running Operations API.
     */
    Response<LongRunningOperationResult> getOperationWithResponse(String operationId, Context context);
}
