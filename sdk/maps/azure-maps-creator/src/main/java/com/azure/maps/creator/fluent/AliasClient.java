...
public interface AliasClient {
    ...
    AliasesCreateResponseInner create();
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    AliasCreateResponse createWithResponse(String creatorDataItemId, Context context);
    ...
    PagedIterable<AliasListItemInner> list();
     ...
     */
    @ServiceMethod(returns = ReturnType.COLLECTION)
    PagedIterable<AliasListItemInner> list(Context context);
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    AliasListItemInner assign(String aliasId, String creatorDataItemId);
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    Response<AliasListItemInner> assignWithResponse(String aliasId, String creatorDataItemId, Context context);
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    Response<Void> deleteWithResponse(String aliasId, Context context);
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    AliasListItemInner getDetails(String aliasId);
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    Response<AliasListItemInner> getDetailsWithResponse(String aliasId, Context context);
}
