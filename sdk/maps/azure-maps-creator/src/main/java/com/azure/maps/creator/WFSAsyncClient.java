...
public final class WFSAsyncClient {
     ...
     */
    WFSAsyncClient(WFSImpl serviceClient) {
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Mono<Response<CollectionsResponse>> getCollectionsWithResponse(String datasetId) {
        return this.serviceClient.getCollectionsWithResponseAsync(datasetId);
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Mono<CollectionsResponse> getCollections(String datasetId) {
        return this.serviceClient.getCollectionsAsync(datasetId);
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Mono<Response<Void>> deleteFeatureWithResponse(String datasetId, String collectionId, String featureId) {
        return this.serviceClient.deleteFeatureWithResponseAsync(datasetId, collectionId, featureId);
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Mono<Void> deleteFeature(String datasetId, String collectionId, String featureId) {
        return this.serviceClient.deleteFeatureAsync(datasetId, collectionId, featureId);
    }
}
