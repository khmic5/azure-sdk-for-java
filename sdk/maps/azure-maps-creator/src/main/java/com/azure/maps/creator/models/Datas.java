...
/** Resource collection API of Datas. */
public interface Datas {
     ...
     */
    LongRunningOperationResult uploadPreview(
     ...
     * @return the response model for a Long-Running Operations API.
     */
    LongRunningOperationResult uploadPreview(UploadDataFormat uploadDataFormat, Object uploadContent);
     ...
     */
    MapDataListResponse listPreview();
     ...
     * @return the response model for the Data List API.
     */
    Response<MapDataListResponse> listPreviewWithResponse(Context context);
     ...
     * @return the response model for a Long-Running Operations API.
     */
    LongRunningOperationResult updatePreview(String uniqueDataId, Object updateContent, String uploadDataDescription);
     ...
     * @return the response model for a Long-Running Operations API.
     */
    LongRunningOperationResult updatePreview(String uniqueDataId, Object updateContent);
     ...
     * @return the response model for a Long-Running Operations API.
     */
    LongRunningOperationResult updatePreview(
     ...
     * @return the response model for a Long-Running Operations API.
     */
    LongRunningOperationResult getOperationPreview(String operationId);
     ...
     * @return the response model for a Long-Running Operations API.
     */
    Response<LongRunningOperationResult> getOperationPreviewWithResponse(String operationId, Context context);
}
