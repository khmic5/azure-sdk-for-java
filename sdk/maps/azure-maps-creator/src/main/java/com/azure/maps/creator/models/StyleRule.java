 ...
 * NumberRule, StringRuleObject and BooleanRule definitions [here](https://aka.ms/AzureMapsStatesetStyles).
 */
@JsonTypeInfo(
        use = JsonTypeInfo.Id.NAME,
        include = JsonTypeInfo.As.PROPERTY,
        property = "type",
        defaultImpl = StyleRule.class)
@JsonTypeName("StyleRule")
@JsonSubTypes({
    @JsonSubTypes.Type(name = "boolean", value = BooleanStyleRule.class),
    @JsonSubTypes.Type(name = "number", value = NumberStyleRule.class),
    @JsonSubTypes.Type(name = "string", value = StringStyleRule.class)
})
@Fluent
public class StyleRule {
     ...
     * @return the StyleRule object itself.
     */
    public StyleRule setKeyName(String keyName) {
