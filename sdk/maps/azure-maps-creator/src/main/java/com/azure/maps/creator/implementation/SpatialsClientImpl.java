...
/** An instance of this class provides access to all the operations defined in SpatialsClient. */
public final class SpatialsClientImpl implements SpatialsClient {
    private final ClientLogger logger = new ClientLogger(SpatialsClientImpl.class);
    ...
    /**
     * Initializes an instance of SpatialsClientImpl.
     *
     * @param client the instance of the service client containing this operation class.
     */
    SpatialsClientImpl(CreatorClientImpl client) {
    ...
    private interface SpatialsService {
        ...
        @ExpectedResponses({200})
        @UnexpectedResponseExceptionType(ManagementException.class)
        Mono<Response<BufferResponseInner>> postBuffer(
            @HostParam("geography") Geography geography,
            @HeaderParam("x-ms-client-id") String xMsClientId,
            @QueryParam("api-version") String apiVersion,
            @PathParam("format") ResponseFormat format,
        ...
        @ExpectedResponses({200})
        @UnexpectedResponseExceptionType(ManagementException.class)
        Mono<Response<BufferResponseInner>> getBuffer(
            @HostParam("geography") Geography geography,
            @HeaderParam("x-ms-client-id") String xMsClientId,
            @QueryParam("api-version") String apiVersion,
            @PathParam("format") ResponseFormat format,
        ...
        @ExpectedResponses({200})
        @UnexpectedResponseExceptionType(ManagementException.class)
        Mono<Response<ClosestPointResponseInner>> postClosestPoint(
            @HostParam("geography") Geography geography,
            @HeaderParam("x-ms-client-id") String xMsClientId,
            @QueryParam("api-version") String apiVersion,
            @PathParam("format") ResponseFormat format,
        ...
        @ExpectedResponses({200})
        @UnexpectedResponseExceptionType(ManagementException.class)
        Mono<Response<ClosestPointResponseInner>> getClosestPoint(
            @HostParam("geography") Geography geography,
            @HeaderParam("x-ms-client-id") String xMsClientId,
            @QueryParam("api-version") String apiVersion,
            @PathParam("format") ResponseFormat format,
        ...
        @ExpectedResponses({200})
        @UnexpectedResponseExceptionType(ManagementException.class)
        Mono<Response<PointInPolygonResponseInner>> postPointInPolygon(
            @HostParam("geography") Geography geography,
            @HeaderParam("x-ms-client-id") String xMsClientId,
            @QueryParam("api-version") String apiVersion,
            @PathParam("format") ResponseFormat format,
        ...
        @ExpectedResponses({200})
        @UnexpectedResponseExceptionType(ManagementException.class)
        Mono<Response<PointInPolygonResponseInner>> getPointInPolygon(
            @HostParam("geography") Geography geography,
            @HeaderParam("x-ms-client-id") String xMsClientId,
            @QueryParam("api-version") String apiVersion,
            @PathParam("format") ResponseFormat format,
        ...
        @ExpectedResponses({200})
        @UnexpectedResponseExceptionType(ManagementException.class)
        Mono<Response<GreatCircleDistanceResponseInner>> getGreatCircleDistance(
            @HostParam("geography") Geography geography,
            @HeaderParam("x-ms-client-id") String xMsClientId,
            @QueryParam("api-version") String apiVersion,
            @PathParam("format") ResponseFormat format,
    ...
    private Mono<SpatialsGetGeofenceResponse> getGeofenceWithResponseAsync(
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<GeofenceResponseInner> getGeofenceAsync(
        ResponseFormat format,
        String deviceId,
        String udid,
        float latitude,
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public GeofenceResponseInner getGeofence(
        ResponseFormat format, String deviceId, String udid, float latitude, float longitude) {
        final Float z = null;
        final OffsetDateTime userTime = null;
        final Float searchBuffer = null;
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<SpatialsPostGeofenceResponse> postGeofenceWithResponseAsync(
        ResponseFormat format,
        String deviceId,
        float latitude,
        float longitude,
        ...
        if (searchGeofenceRequestBody == null) {
            return Mono
                .error(
                    new IllegalArgumentException(
                        "Parameter searchGeofenceRequestBody is required and cannot be null."));
        } else {
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<GeofenceResponseInner> postGeofenceAsync(
        ResponseFormat format,
        String deviceId,
        float latitude,
        float longitude,
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public GeofenceResponseInner postGeofence(
        ResponseFormat format,
        String deviceId,
        float latitude,
        float longitude,
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<Response<BufferResponseInner>> postBufferWithResponseAsync(
        ...
        if (bufferRequestBody == null) {
            return Mono
                .error(new IllegalArgumentException("Parameter bufferRequestBody is required and cannot be null."));
        } else {
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<BufferResponseInner> postBufferAsync(ResponseFormat format, BufferRequestBody bufferRequestBody) {
        return postBufferWithResponseAsync(format, bufferRequestBody)
            .flatMap(
                (Response<BufferResponseInner> res) -> {
                    if (res.getValue() != null) {
                        return Mono.just(res.getValue());
                    } else {
                        return Mono.empty();
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public BufferResponseInner postBuffer(ResponseFormat format, BufferRequestBody bufferRequestBody) {
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Response<BufferResponseInner> postBufferWithResponse(
        ResponseFormat format, BufferRequestBody bufferRequestBody, Context context) {
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<Response<BufferResponseInner>> getBufferWithResponseAsync(
        ...
        if (distances == null) {
            return Mono.error(new IllegalArgumentException("Parameter distances is required and cannot be null."));
        }
        final String apiVersion = "1.0";
        final String accept = "application/json";
        return FluxUtil
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<BufferResponseInner> getBufferAsync(ResponseFormat format, String udid, String distances) {
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public BufferResponseInner getBuffer(ResponseFormat format, String udid, String distances) {
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Response<BufferResponseInner> getBufferWithResponse(
        ResponseFormat format, String udid, String distances, Context context) {
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<Response<ClosestPointResponseInner>> postClosestPointWithResponseAsync(
        ResponseFormat format,
        float latitude,
        float longitude,
        ...
        if (closestPointRequestBody == null) {
            return Mono
                .error(
                    new IllegalArgumentException("Parameter closestPointRequestBody is required and cannot be null."));
        } else {
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<ClosestPointResponseInner> postClosestPointAsync(
        ResponseFormat format,
        float latitude,
        float longitude,
        GeoJsonFeatureCollection closestPointRequestBody,
        ...
        return postClosestPointWithResponseAsync(
            ...
            .flatMap(
                (Response<ClosestPointResponseInner> res) -> {
                    if (res.getValue() != null) {
                        return Mono.just(res.getValue());
                    } else {
                        return Mono.empty();
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public ClosestPointResponseInner postClosestPoint(
        ResponseFormat format, float latitude, float longitude, GeoJsonFeatureCollection closestPointRequestBody) {
        final Integer numberOfClosestPoints = null;
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Response<ClosestPointResponseInner> postClosestPointWithResponse(
        ResponseFormat format,
        float latitude,
        float longitude,
        GeoJsonFeatureCollection closestPointRequestBody,
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<Response<ClosestPointResponseInner>> getClosestPointWithResponseAsync(
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<ClosestPointResponseInner> getClosestPointAsync(
        ResponseFormat format, String udid, float latitude, float longitude, Integer numberOfClosestPoints) {
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public ClosestPointResponseInner getClosestPoint(
        ResponseFormat format, String udid, float latitude, float longitude) {
        final Integer numberOfClosestPoints = null;
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Response<ClosestPointResponseInner> getClosestPointWithResponse(
        ResponseFormat format,
        String udid,
        float latitude,
        float longitude,
        Integer numberOfClosestPoints,
        Context context) {
        return getClosestPointWithResponseAsync(format, udid, latitude, longitude, numberOfClosestPoints, context)
            .block();
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<Response<PointInPolygonResponseInner>> postPointInPolygonWithResponseAsync(
        ...
        if (pointInPolygonRequestBody == null) {
            return Mono
                .error(
                    new IllegalArgumentException(
                        "Parameter pointInPolygonRequestBody is required and cannot be null."));
        } else {
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<PointInPolygonResponseInner> postPointInPolygonAsync(
        ResponseFormat format, float latitude, float longitude, GeoJsonFeatureCollection pointInPolygonRequestBody) {
        return postPointInPolygonWithResponseAsync(format, latitude, longitude, pointInPolygonRequestBody)
            .flatMap(
                (Response<PointInPolygonResponseInner> res) -> {
                    if (res.getValue() != null) {
                        return Mono.just(res.getValue());
                    } else {
                        return Mono.empty();
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public PointInPolygonResponseInner postPointInPolygon(
        ResponseFormat format, float latitude, float longitude, GeoJsonFeatureCollection pointInPolygonRequestBody) {
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Response<PointInPolygonResponseInner> postPointInPolygonWithResponse(
        ResponseFormat format,
        float latitude,
        float longitude,
        GeoJsonFeatureCollection pointInPolygonRequestBody,
        Context context) {
        return postPointInPolygonWithResponseAsync(format, latitude, longitude, pointInPolygonRequestBody, context)
            .block();
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<Response<PointInPolygonResponseInner>> getPointInPolygonWithResponseAsync(
        ResponseFormat format, String udid, float latitude, float longitude) {
        if (this.client.getGeography() == null) {
            return Mono
                .error(
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<PointInPolygonResponseInner> getPointInPolygonAsync(
        ResponseFormat format, String udid, float latitude, float longitude) {
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public PointInPolygonResponseInner getPointInPolygon(
        ResponseFormat format, String udid, float latitude, float longitude) {
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Response<PointInPolygonResponseInner> getPointInPolygonWithResponse(
        ResponseFormat format, String udid, float latitude, float longitude, Context context) {
        return getPointInPolygonWithResponseAsync(format, udid, latitude, longitude, context).block();
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<Response<GreatCircleDistanceResponseInner>> getGreatCircleDistanceWithResponseAsync(
    ...
    private Mono<Response<GreatCircleDistanceResponseInner>> getGreatCircleDistanceWithResponseAsync(
        ...
        return service
            .getGreatCircleDistance(
                this.client.getGeography(), this.client.getXMsClientId(), apiVersion, format, query, accept, context);
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<GreatCircleDistanceResponseInner> getGreatCircleDistanceAsync(ResponseFormat format, String query) {
        return getGreatCircleDistanceWithResponseAsync(format, query)
            .flatMap(
                (Response<GreatCircleDistanceResponseInner> res) -> {
                    if (res.getValue() != null) {
                        return Mono.just(res.getValue());
                    } else {
                        return Mono.empty();
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public GreatCircleDistanceResponseInner getGreatCircleDistance(ResponseFormat format, String query) {
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Response<GreatCircleDistanceResponseInner> getGreatCircleDistanceWithResponse(
        ResponseFormat format, String query, Context context) {
