...
public final class AliasImpl {
     ...
     */
    AliasImpl(CreatorClientImpl client) {
    ...
    public Mono<AliasCreateResponse> createWithResponseAsync(String creatorDataItemId) {
        ...
        return service.create(
                this.client.getGeography(), this.client.getXMsClientId(), apiVersion, creatorDataItemId, accept);
    }
    ...
    public Mono<Response<Void>> deleteWithResponseAsync(String aliasId) {
        final String apiVersion = "2.0";
        final String accept = "application/json";
        return service.delete(this.client.getGeography(), this.client.getXMsClientId(), aliasId, apiVersion, accept);
    }
    ...
    public Mono<Response<AliasListItem>> getDetailsWithResponseAsync(String aliasId) {
        ...
        return service.getDetails(
                this.client.getGeography(), this.client.getXMsClientId(), aliasId, apiVersion, accept);
    }
