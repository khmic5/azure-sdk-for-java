...
public interface Alias {
     ...
     * @return the response model for the Alias Create API for the case when the alias was successfully created.
     */
    Response<AliasesCreateResponse> createWithResponse(String creatorDataItemId, Context context);
     ...
     */
    PagedIterable<AliasListItem> list();
     ...
     * @return the response model for the List API.
     */
    PagedIterable<AliasListItem> list(Context context);
     ...
     */
    AliasListItem assign(String aliasId, String creatorDataItemId);
     ...
     * @return detailed information for the alias.
     */
    Response<AliasListItem> assignWithResponse(String aliasId, String creatorDataItemId, Context context);
     ...
     * @return detailed information for the alias.
     */
    AliasListItem getDetails(String aliasId);
     ...
     * @return detailed information for the alias.
     */
    Response<AliasListItem> getDetailsWithResponse(String aliasId, Context context);
}
