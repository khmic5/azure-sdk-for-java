...
public final class TilesetsClientImpl implements TilesetsClient {
    private final ClientLogger logger = new ClientLogger(TilesetsClientImpl.class);
    ...
    /**
     * Initializes an instance of TilesetsClientImpl.
     *
     * @param client the instance of the service client containing this operation class.
     */
    TilesetsClientImpl(CreatorClientImpl client) {
        this.service = RestProxy.create(TilesetsService.class, client.getHttpPipeline(), client.getSerializerAdapter());
        this.client = client;
    }

    /**
     * The interface defining all the services for CreatorClientTilesets to be used by the proxy service to perform REST
     * calls.
     */
    @Host("https://{geography}.atlas.microsoft.com")
    @ServiceInterface(name = "CreatorClientTileset")
    private interface TilesetsService {
        ...
        @ExpectedResponses({200})
        @UnexpectedResponseExceptionType(ManagementException.class)
        Mono<Response<TilesetDetailInfoInner>> get(
            @HostParam("geography") Geography geography,
            @HeaderParam("x-ms-client-id") String xMsClientId,
            @QueryParam("api-version") String apiVersion,
    ...
    private Mono<Response<Flux<ByteBuffer>>> createWithResponseAsync(String datasetId, String description) {
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private PollerFlux<PollResult<LongRunningOperationResultInner>, LongRunningOperationResultInner> beginCreateAsync(
        String datasetId, String description) {
        Mono<Response<Flux<ByteBuffer>>> mono = createWithResponseAsync(datasetId, description);
        return this
            .client
    ...
    private PollerFlux<PollResult<LongRunningOperationResultInner>, LongRunningOperationResultInner> beginCreateAsync(
        String datasetId, String description, Context context) {
        context = this.client.mergeContext(context);
        Mono<Response<Flux<ByteBuffer>>> mono = createWithResponseAsync(datasetId, description, context);
        return this
            .client
            .<LongRunningOperationResultInner, LongRunningOperationResultInner>getLroResult(
                mono,
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public SyncPoller<PollResult<LongRunningOperationResultInner>, LongRunningOperationResultInner> beginCreate(
        String datasetId, String description) {
        return beginCreateAsync(datasetId, description).getSyncPoller();
    }
    ...
    public SyncPoller<PollResult<LongRunningOperationResultInner>, LongRunningOperationResultInner> beginCreate(
        String datasetId, String description, Context context) {
        return beginCreateAsync(datasetId, description, context).getSyncPoller();
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<LongRunningOperationResultInner> createAsync(String datasetId, String description) {
        return beginCreateAsync(datasetId, description).last().flatMap(this.client::getLroFinalResultOrError);
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<LongRunningOperationResultInner> createAsync(String datasetId) {
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<LongRunningOperationResultInner> createAsync(String datasetId, String description, Context context) {
        return beginCreateAsync(datasetId, description, context).last().flatMap(this.client::getLroFinalResultOrError);
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public LongRunningOperationResultInner create(String datasetId, String description) {
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public LongRunningOperationResultInner create(String datasetId) {
        final String description = null;
        return createAsync(datasetId, description).block();
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public LongRunningOperationResultInner create(String datasetId, String description, Context context) {
        return createAsync(datasetId, description, context).block();
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<PagedResponse<TilesetDetailInfoInner>> listSinglePageAsync() {
        if (this.client.getGeography() == null) {
            return Mono
                .error(
                    new IllegalArgumentException(
        ...
        return FluxUtil
            ...
            .<PagedResponse<TilesetDetailInfoInner>>map(
                res ->
                    new PagedResponseBase<>(
                        res.getRequest(),
                        res.getStatusCode(),
                        res.getHeaders(),
                        res.getValue().tilesets(),
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<PagedResponse<TilesetDetailInfoInner>> listSinglePageAsync(Context context) {
        if (this.client.getGeography() == null) {
            return Mono
                .error(
                    new IllegalArgumentException(
    ...
    private PagedFlux<TilesetDetailInfoInner> listAsync() {
     ...
     */
    @ServiceMethod(returns = ReturnType.COLLECTION)
    private PagedFlux<TilesetDetailInfoInner> listAsync(Context context) {
     ...
     */
    @ServiceMethod(returns = ReturnType.COLLECTION)
    public PagedIterable<TilesetDetailInfoInner> list() {
     ...
     */
    @ServiceMethod(returns = ReturnType.COLLECTION)
    public PagedIterable<TilesetDetailInfoInner> list(Context context) {
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<Response<TilesetDetailInfoInner>> getWithResponseAsync(String tilesetId) {
        if (this.client.getGeography() == null) {
            return Mono
                .error(
                    new IllegalArgumentException(
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<Response<TilesetDetailInfoInner>> getWithResponseAsync(String tilesetId, Context context) {
        if (this.client.getGeography() == null) {
            return Mono
                .error(
                    new IllegalArgumentException(
        ...
        context = this.client.mergeContext(context);
        return service
            .get(this.client.getGeography(), this.client.getXMsClientId(), apiVersion, tilesetId, accept, context);
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<TilesetDetailInfoInner> getAsync(String tilesetId) {
        return getWithResponseAsync(tilesetId)
            .flatMap(
                (Response<TilesetDetailInfoInner> res) -> {
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public TilesetDetailInfoInner get(String tilesetId) {
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Response<TilesetDetailInfoInner> getWithResponse(String tilesetId, Context context) {
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<Response<Void>> deleteWithResponseAsync(String tilesetId) {
        if (this.client.getGeography() == null) {
            return Mono
                .error(
                    new IllegalArgumentException(
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<Response<Void>> deleteWithResponseAsync(String tilesetId, Context context) {
        if (this.client.getGeography() == null) {
            return Mono
                .error(
                    new IllegalArgumentException(
        ...
        context = this.client.mergeContext(context);
        return service
            .delete(this.client.getGeography(), this.client.getXMsClientId(), apiVersion, tilesetId, accept, context);
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<Void> deleteAsync(String tilesetId) {
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<TilesetsGetOperationResponse> getOperationWithResponseAsync(String operationId) {
        if (this.client.getGeography() == null) {
            return Mono
                .error(
                    new IllegalArgumentException(
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<TilesetsGetOperationResponse> getOperationWithResponseAsync(String operationId, Context context) {
        if (this.client.getGeography() == null) {
            return Mono
                .error(
                    new IllegalArgumentException(
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<PagedResponse<TilesetDetailInfoInner>> listNextSinglePageAsync(String nextLink) {
        if (nextLink == null) {
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<PagedResponse<TilesetDetailInfoInner>> listNextSinglePageAsync(String nextLink, Context context) {
        if (nextLink == null) {
            return Mono.error(new IllegalArgumentException("Parameter nextLink is required and cannot be null."));
        }
        if (this.client.getGeography() == null) {
