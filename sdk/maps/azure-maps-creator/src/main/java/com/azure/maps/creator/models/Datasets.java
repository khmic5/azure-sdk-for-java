...
public interface Datasets {
     ...
     */
    LongRunningOperationResult create(String conversionId, String datasetId, String descriptionDataset);
     ...
     * @return the response model for a Long-Running Operations API.
     */
    LongRunningOperationResult create(String conversionId);
     ...
     * @return the response model for a Long-Running Operations API.
     */
    LongRunningOperationResult create(
     ...
     */
    PagedIterable<DatasetDetailInfo> list();
     ...
     * @return the response model for the Dataset List API.
     */
    PagedIterable<DatasetDetailInfo> list(Context context);
     ...
     */
    DatasetDetailInfo get(String datasetId);
     ...
     * @return detail information for the dataset.
     */
    Response<DatasetDetailInfo> getWithResponse(String datasetId, Context context);
