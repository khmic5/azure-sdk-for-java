...
public final class DatasetClient {
    ...
    public SyncPoller<LongRunningOperationResult, LongRunningOperationResult> beginCreate(
        ...
        return this.serviceClient.beginCreate(conversionId, datasetId, description);
    }
    ...
    public SyncPoller<LongRunningOperationResult, LongRunningOperationResult> beginCreate(
        ...
        return this.serviceClient.beginCreate(conversionId, datasetId, description, context);
    }
