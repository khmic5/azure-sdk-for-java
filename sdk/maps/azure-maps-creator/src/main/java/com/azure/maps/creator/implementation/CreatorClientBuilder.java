...
/** A builder for creating a new instance of the CreatorClientImpl type. */
@ServiceClientBuilder(serviceClients = {CreatorClientImpl.class})
public final class CreatorClientBuilder {
     ...
     */
    public CreatorClientBuilder xMsClientId(String xMsClientId) {
     ...
     * @return the CreatorClientBuilder.
     */
    public CreatorClientBuilder environment(AzureEnvironment environment) {
     ...
     * @return the CreatorClientBuilder.
     */
    public CreatorClientBuilder defaultPollInterval(Duration defaultPollInterval) {
     ...
     */
    public CreatorClientImpl buildClient() {
        if (geography == null) {
        ...
        CreatorClientImpl client =
            new CreatorClientImpl(
