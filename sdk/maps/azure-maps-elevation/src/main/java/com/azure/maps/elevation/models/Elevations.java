...
/** Resource collection API of Elevations. */
public interface Elevations {
     ...
     */
    PointsResult getDataForPoints(ResponseFormat format, List<String> points);
     ...
     * @return the response from a successful Elevation Points request.
     */
    Response<PointsResult> getDataForPointsWithResponse(ResponseFormat format, List<String> points, Context context);
     ...
     * @return the response from a successful Elevation Points request.
     */
    PointsResult postDataForPoints(ResponseFormat format, List<CoordinatesPairAbbreviated> pointsRequestBody);
     ...
     * @return the response from a successful Elevation Points request.
     */
    Response<PointsResult> postDataForPointsWithResponse(
     ...
     */
    LinesResult getDataForPolyline(ResponseFormat format, List<String> lines);
     ...
     * @return the response from a successful Elevation Polyline request.
     */
    Response<LinesResult> getDataForPolylineWithResponse(
     ...
     * @return the response from a successful Elevation Polyline request.
     */
    LinesResult postDataForPolyline(ResponseFormat format, List<CoordinatesPairAbbreviated> linesRequestBody);
     ...
     * @return the response from a successful Elevation Polyline request.
     */
    Response<LinesResult> postDataForPolylineWithResponse(
     ...
     */
    BoundingBoxResult getDataForBoundingBox(ResponseFormat format, List<String> bounds, int rows, int columns);
     ...
     * @return the response from a successful Get Data for Bounding Box API.
     */
    Response<BoundingBoxResult> getDataForBoundingBoxWithResponse(
