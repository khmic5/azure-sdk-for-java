...
/** Initializes a new instance of the ElevationClientImpl type. */
@ServiceClient(builder = ElevationClientBuilder.class)
public final class ElevationClientImpl implements ElevationClient {
    ...
    /** The ElevationsClient object to access its operations. */
    private final ElevationsClient elevations;

    /**
     * Gets the ElevationsClient object to access its operations.
     *
     * @return the ElevationsClient object.
     */
    public ElevationsClient getElevations() {
    ...
    ElevationClientImpl(
        ...
        this.apiVersion = "1.0";
        this.elevations = new ElevationsClientImpl(this);
    }
