...
/** A builder for creating a new instance of the ElevationClientImpl type. */
...
public final class ElevationClientBuilder {
     ...
     * @return the ElevationClientBuilder.
     */
    public ElevationClientBuilder geography(Geography geography) {
     ...
     * @return the ElevationClientBuilder.
     */
    public ElevationClientBuilder environment(AzureEnvironment environment) {
     ...
     * @return the ElevationClientBuilder.
     */
    public ElevationClientBuilder defaultPollInterval(Duration defaultPollInterval) {
     ...
     * @return the ElevationClientBuilder.
     */
    public ElevationClientBuilder serializerAdapter(SerializerAdapter serializerAdapter) {
