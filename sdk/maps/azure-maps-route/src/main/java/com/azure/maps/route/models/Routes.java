...
public interface Routes {
     ...
     */
    RouteMatrixResponse postRouteMatrix(
     ...
     * @return this object is returned from a successful Route Matrix call.
     */
    RouteMatrixResponse postRouteMatrix(ResponseFormat format, PostRouteMatrixRequestBody postRouteMatrixRequestBody);
     ...
     * @return this object is returned from a successful Route Matrix call.
     */
    RouteMatrixResponse getRouteMatrix(String format);
     ...
     * @return this object is returned from a successful Route Matrix call.
     */
    RouteMatrixResponse getRouteMatrix(String format, Context context);
     ...
     * @return this object is returned from a successful Route Matrix call.
     */
    RouteMatrixResponse postRouteMatrixSync(
     ...
     * @return this object is returned from a successful Route Matrix call.
     */
    Response<RouteMatrixResponse> postRouteMatrixSyncWithResponse(
        ResponseFormat format,
        PostRouteMatrixRequestBody postRouteMatrixRequestBody,
        Boolean waitForResults,
        ComputeTravelTimeFor computeTravelTimeFor,
     ...
     */
    RouteDirectionsResponse getRouteDirections(TextFormat format, String query);
     ...
     * @return this object is returned from a successful Route Directions call.
     */
    Response<RouteDirectionsResponse> getRouteDirectionsWithResponse(
        TextFormat format,
        String query,
     ...
     * @return this object is returned from a successful Route Directions call.
     */
    RouteDirectionsResponse postRouteDirections(
     ...
     * @return this object is returned from a successful Route Directions call.
     */
    Response<RouteDirectionsResponse> postRouteDirectionsWithResponse(
        TextFormat format,
        String query,
     ...
     */
    GetRouteRangeResponse getRouteRange(TextFormat format, String query);
     ...
     * @return this object is returned from a successful Route Reachable Range call.
     */
    Response<GetRouteRangeResponse> getRouteRangeWithResponse(
        TextFormat format,
        String query,
     ...
     */
    RouteDirectionsBatchResponse postRouteDirectionsBatch(
     ...
     * @return this object is returned from a successful Route Directions Batch service call.
     */
    RouteDirectionsBatchResponse getRouteDirectionsBatch(String format);
     ...
     * @return this object is returned from a successful Route Directions Batch service call.
     */
    RouteDirectionsBatchResponse getRouteDirectionsBatch(String format, Context context);
     ...
     * @return this object is returned from a successful Route Directions Batch service call.
     */
    RouteDirectionsBatchResponse postRouteDirectionsBatchSync(
        ResponseFormat format, BatchRequestBody postRouteDirectionsBatchRequestBody);
     ...
     * @return this object is returned from a successful Route Directions Batch service call.
     */
    Response<RouteDirectionsBatchResponse> postRouteDirectionsBatchSyncWithResponse(
        ResponseFormat format, BatchRequestBody postRouteDirectionsBatchRequestBody, Context context);
}
