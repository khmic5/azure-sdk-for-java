...
import com.azure.maps.route.models.GetRouteDirectionsBatchResponse;
import com.azure.maps.route.models.GetRouteMatrixResponse;
...
import com.azure.maps.route.models.RequestRouteDirectionsBatchResponse;
import com.azure.maps.route.models.RequestRouteMatrixResponse;
...
public final class RouteClientImpl {
    ...
    private final RouteClientService service;
    ...
    public RouteClientImpl(
        ...
        this.service = RestProxy.create(RouteClientService.class, this.httpPipeline, this.getSerializerAdapter());
    }

    /**
     * The interface defining all the services for RouteClient to be used by the proxy service to perform REST calls.
     */
    @Host("{$host}")
    @ServiceInterface(name = "RouteClient")
    private interface RouteClientService {
        @Post("/route/matrix/{format}")
        @ExpectedResponses({200, 202})
        @UnexpectedResponseExceptionType(ErrorResponseException.class)
        Mono<RequestRouteMatrixResponse> requestRouteMatrix(
        ...
        @ExpectedResponses({200, 202})
        @UnexpectedResponseExceptionType(ErrorResponseException.class)
        Mono<GetRouteMatrixResponse> getRouteMatrix(
                @HostParam("$host") String host,
                @HeaderParam("x-ms-client-id") String clientId,
                @QueryParam("api-version") String apiVersion,
        ...
        Mono<Response<RouteDirections>> getRouteDirectionsWithAdditionalParameters(
                ...
                @QueryParam("maxChargeInkWh") Double maxChargeInKwH,
                @QueryParam("auxiliaryPowerInkW") Double auxiliaryPowerInKw,
                @BodyParam("application/json") RouteDirectionParameters routeDirectionParameters,
                @HeaderParam("Accept") String accept);
        ...
        @ExpectedResponses({200, 202})
        @UnexpectedResponseExceptionType(ErrorResponseException.class)
        Mono<RequestRouteDirectionsBatchResponse> requestRouteDirectionsBatch(
                @HostParam("$host") String host,
                @HeaderParam("x-ms-client-id") String clientId,
                @QueryParam("api-version") String apiVersion,
                @PathParam("format") JsonFormat format,
        ...
        @ExpectedResponses({200, 202})
        @UnexpectedResponseExceptionType(ErrorResponseException.class)
        Mono<GetRouteDirectionsBatchResponse> getRouteDirectionsBatch(
                @HostParam("$host") String host,
                @HeaderParam("x-ms-client-id") String clientId,
                @QueryParam("api-version") String apiVersion,
    ...
    public Mono<RequestRouteMatrixResponse> requestRouteMatrixWithResponseAsync(
            JsonFormat format,
    ...
    public PollerFlux<RouteMatrixResult, RouteMatrixResult> beginRequestRouteMatrixAsync(
        ...
        return PollerFlux.create(
                ...
                new TypeReference<RouteMatrixResult>() {},
                new TypeReference<RouteMatrixResult>() {});
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Mono<GetRouteMatrixResponse> getRouteMatrixWithResponseAsync(String matrixId) {
        final String accept = "application/json";
        return service.getRouteMatrix(this.getHost(), this.getClientId(), this.getApiVersion(), matrixId, accept);
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Mono<RequestRouteDirectionsBatchResponse> requestRouteDirectionsBatchWithResponseAsync(
            JsonFormat format, BatchRequest routeDirectionsBatchQueries) {
        final String accept = "application/json";
        return service.requestRouteDirectionsBatch(
                this.getHost(), this.getClientId(), this.getApiVersion(), format, routeDirectionsBatchQueries, accept);
    }
    ...
    public PollerFlux<RouteDirectionsBatchResult, RouteDirectionsBatchResult> beginRequestRouteDirectionsBatchAsync(
        ...
        return PollerFlux.create(
                ...
                new DefaultPollingStrategy<>(this.getHttpPipeline()),
                new TypeReference<RouteDirectionsBatchResult>() {},
                new TypeReference<RouteDirectionsBatchResult>() {});
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Mono<GetRouteDirectionsBatchResponse> getRouteDirectionsBatchWithResponseAsync(String batchId) {
        final String accept = "application/json";
        return service.getRouteDirectionsBatch(
                this.getHost(), this.getClientId(), this.getApiVersion(), batchId, accept);
    }
