 ...
 */
@Immutable
public final class RouteMatrixResponseInner {
    @JsonIgnore private final ClientLogger logger = new ClientLogger(RouteMatrixResponseInner.class);
    ...
    public void validate() {
        if (matrix() != null) {
            matrix().forEach(e -> e.forEach(e1 -> e1.validate()));
        }
        if (summary() != null) {
            summary().validate();
        }
