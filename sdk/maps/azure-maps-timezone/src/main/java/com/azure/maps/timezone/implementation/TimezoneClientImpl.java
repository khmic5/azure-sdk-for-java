...
public final class TimezoneClientImpl {
     ...
     */
    public TimezoneClientImpl(String xMsClientId, Geography geography, String apiVersion) {
        this(
     ...
     * @param apiVersion Api Version.
     */
    public TimezoneClientImpl(HttpPipeline httpPipeline, String xMsClientId, Geography geography, String apiVersion) {
