...
public final class TimezoneClientBuilder {
    ...
    /** Create an instance of the TimezoneClientBuilder. */
     ...
     */
    public TimezoneClientBuilder clientId(String clientId) {
     ...
     * @return the TimezoneClientBuilder.
     */
    public TimezoneClientBuilder apiVersion(String apiVersion) {
    ...
    public TimezoneAsyncClient buildAsyncClient() {
        return new TimezoneAsyncClient(buildInnerClient());
    }
    ...
    public TimezoneClient buildClient() {
        return new TimezoneClient(buildInnerClient());
    }
}
