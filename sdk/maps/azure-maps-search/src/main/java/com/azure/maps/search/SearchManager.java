...
import com.azure.maps.search.implementation.SearchClientBuilder;
...
/** Entry point to SearchManager. Azure Maps Search REST APIs. */
public final class SearchManager {
    private Searches searches;

    private final SearchClient clientObject;

    private SearchManager(HttpPipeline httpPipeline, AzureProfile profile, Duration defaultPollInterval) {
        Objects.requireNonNull(httpPipeline, "'httpPipeline' cannot be null.");
        Objects.requireNonNull(profile, "'profile' cannot be null.");
        this.clientObject =
            new SearchClientBuilder().pipeline(httpPipeline).defaultPollInterval(defaultPollInterval).buildClient();
    }
    ...
    /** @return Resource collection API of Searches. */
    public Searches searches() {
        if (this.searches == null) {
            this.searches = new SearchesImpl(clientObject.getSearches(), this);
        }
        return searches;
    }

    /**
     * @return Wrapped service client SearchClient providing direct access to the underlying auto-generated API
     *     implementation, based on Azure REST API.
     */
    public SearchClient serviceClient() {
