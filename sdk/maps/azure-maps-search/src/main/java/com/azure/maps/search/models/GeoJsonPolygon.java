...
public final class GeoJsonPolygon extends GeoJsonGeometry {
    @JsonIgnore private final ClientLogger logger = new ClientLogger(GeoJsonPolygon.class);
     ...
     */
    public GeoJsonPolygon withCoordinates(List<List<List<Double>>> coordinates) {
    ...
    public void validate() {
        ...
        if (coordinates() == null) {
            throw logger
                .logExceptionAsError(
                    new IllegalArgumentException("Missing required property coordinates in model GeoJsonPolygon"));
        }
    }
}
