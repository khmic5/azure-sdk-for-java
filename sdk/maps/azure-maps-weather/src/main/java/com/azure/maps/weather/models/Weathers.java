...
/** Resource collection API of Weathers. */
public interface Weathers {
     ...
     * @return the response.
     */
    HourlyForecastResponse getHourlyForecast(ResponseFormat format, String query);
     ...
     * @return the response.
     */
    Response<HourlyForecastResponse> getHourlyForecastWithResponse(
     ...
     * @return the response.
     */
    MinuteForecastResponse getMinuteForecast(ResponseFormat format, String query);
     ...
     * @return the response.
     */
    Response<MinuteForecastResponse> getMinuteForecastWithResponse(
     ...
     * @return the response.
     */
    QuarterDayForecastResponse getQuarterDayForecast(ResponseFormat format, String query);
     ...
     * @return the response.
     */
    Response<QuarterDayForecastResponse> getQuarterDayForecastWithResponse(
        ResponseFormat format, String query, WeatherDataUnit unit, Integer duration, String language, Context context);
     ...
     * @return the response.
     */
    CurrentConditionsResponse getCurrentConditions(ResponseFormat format, String query);
     ...
     * @return the response.
     */
    Response<CurrentConditionsResponse> getCurrentConditionsWithResponse(
     ...
     * @return the response.
     */
    DailyForecastResponse getDailyForecast(ResponseFormat format, String query);
     ...
     * @return the response.
     */
    Response<DailyForecastResponse> getDailyForecastWithResponse(
        ResponseFormat format, String query, WeatherDataUnit unit, Integer duration, String language, Context context);
     ...
     */
    WeatherAlongRouteResponse getWeatherAlongRoute(ResponseFormat format, String query);
     ...
     * @return this object is returned from a successful Weather Along Route.
     */
    Response<WeatherAlongRouteResponse> getWeatherAlongRouteWithResponse(
     ...
     */
    SevereWeatherAlertsResponse getSevereWeatherAlerts(ResponseFormat format, String query);
     ...
     * @return this object is returned from a successful Get Severe Weather Alerts call.
     */
    Response<SevereWeatherAlertsResponse> getSevereWeatherAlertsWithResponse(
     ...
     */
    DailyIndicesResponse getDailyIndices(ResponseFormat format, String query);
     ...
     * @return this object is returned from a successful Get Daily Indices call.
     */
    Response<DailyIndicesResponse> getDailyIndicesWithResponse(
        ResponseFormat format,
        String query,
        String language,
        Integer duration,
