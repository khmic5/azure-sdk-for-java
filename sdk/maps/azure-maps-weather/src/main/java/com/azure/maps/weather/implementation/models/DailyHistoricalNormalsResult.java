...
public final class DailyHistoricalNormalsResult {
    ...
    /**
     * Set the historicalNormals property: Historical normals for each requested day.
     *
     * @param historicalNormals the historicalNormals value to set.
     * @return the DailyHistoricalNormalsResult object itself.
     */
    public DailyHistoricalNormalsResult setHistoricalNormals(List<DailyHistoricalNormals> historicalNormals) {
        this.historicalNormals = historicalNormals;
        return this;
    }
     ...
     * @return the DailyHistoricalNormalsResult object itself.
     */
    public DailyHistoricalNormalsResult setNextLink(String nextLink) {
