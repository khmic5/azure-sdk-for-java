...
/** An instance of this class provides access to all the operations defined in WeathersClient. */
public final class WeathersClientImpl implements WeathersClient {
    private final ClientLogger logger = new ClientLogger(WeathersClientImpl.class);
    ...
    /**
     * Initializes an instance of WeathersClientImpl.
     *
     * @param client the instance of the service client containing this operation class.
     */
    WeathersClientImpl(WeatherClientImpl client) {
    ...
    private interface WeathersService {
        ...
        Mono<Response<HourlyForecastResponseInner>> getHourlyForecast(
        ...
        @ExpectedResponses({200})
        @UnexpectedResponseExceptionType(ManagementException.class)
        Mono<Response<MinuteForecastResponseInner>> getMinuteForecast(
            @HostParam("geography") Geography geography,
            @HeaderParam("x-ms-client-id") String xMsClientId,
            @QueryParam("api-version") String apiVersion,
            @PathParam("format") ResponseFormat format,
        ...
        @ExpectedResponses({200})
        @UnexpectedResponseExceptionType(ManagementException.class)
        Mono<Response<QuarterDayForecastResponseInner>> getQuarterDayForecast(
            @HostParam("geography") Geography geography,
            @HeaderParam("x-ms-client-id") String xMsClientId,
            @QueryParam("api-version") String apiVersion,
            @PathParam("format") ResponseFormat format,
        ...
        @ExpectedResponses({200})
        @UnexpectedResponseExceptionType(ManagementException.class)
        Mono<Response<CurrentConditionsResponseInner>> getCurrentConditions(
            @HostParam("geography") Geography geography,
            @HeaderParam("x-ms-client-id") String xMsClientId,
            @QueryParam("api-version") String apiVersion,
            @PathParam("format") ResponseFormat format,
        ...
        @ExpectedResponses({200})
        @UnexpectedResponseExceptionType(ManagementException.class)
        Mono<Response<DailyForecastResponseInner>> getDailyForecast(
            @HostParam("geography") Geography geography,
            @HeaderParam("x-ms-client-id") String xMsClientId,
            @QueryParam("api-version") String apiVersion,
            @PathParam("format") ResponseFormat format,
        ...
        @ExpectedResponses({200})
        @UnexpectedResponseExceptionType(ManagementException.class)
        Mono<Response<WeatherAlongRouteResponseInner>> getWeatherAlongRoute(
            @HostParam("geography") Geography geography,
            @HeaderParam("x-ms-client-id") String xMsClientId,
            @QueryParam("api-version") String apiVersion,
            @PathParam("format") ResponseFormat format,
        ...
        @ExpectedResponses({200})
        @UnexpectedResponseExceptionType(ManagementException.class)
        Mono<Response<SevereWeatherAlertsResponseInner>> getSevereWeatherAlerts(
            @HostParam("geography") Geography geography,
            @HeaderParam("x-ms-client-id") String xMsClientId,
            @QueryParam("api-version") String apiVersion,
            @PathParam("format") ResponseFormat format,
        ...
        @ExpectedResponses({200})
        @UnexpectedResponseExceptionType(ManagementException.class)
        Mono<Response<DailyIndicesResponseInner>> getDailyIndices(
            @HostParam("geography") Geography geography,
            @HeaderParam("x-ms-client-id") String xMsClientId,
            @QueryParam("api-version") String apiVersion,
            @PathParam("format") ResponseFormat format,
    ...
    private Mono<Response<HourlyForecastResponseInner>> getHourlyForecastWithResponseAsync(
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<HourlyForecastResponseInner> getHourlyForecastAsync(
        ResponseFormat format, String query, WeatherDataUnit unit, Integer duration, String language) {
        return getHourlyForecastWithResponseAsync(format, query, unit, duration, language)
            .flatMap(
                (Response<HourlyForecastResponseInner> res) -> {
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<HourlyForecastResponseInner> getHourlyForecastAsync(ResponseFormat format, String query) {
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public HourlyForecastResponseInner getHourlyForecast(ResponseFormat format, String query) {
        final WeatherDataUnit unit = null;
        final Integer duration = null;
        final String language = null;
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Response<HourlyForecastResponseInner> getHourlyForecastWithResponse(
        ResponseFormat format, String query, WeatherDataUnit unit, Integer duration, String language, Context context) {
        return getHourlyForecastWithResponseAsync(format, query, unit, duration, language, context).block();
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<Response<MinuteForecastResponseInner>> getMinuteForecastWithResponseAsync(
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<MinuteForecastResponseInner> getMinuteForecastAsync(
        ResponseFormat format, String query, Integer interval, String language) {
        return getMinuteForecastWithResponseAsync(format, query, interval, language)
            .flatMap(
                (Response<MinuteForecastResponseInner> res) -> {
                    if (res.getValue() != null) {
                        return Mono.just(res.getValue());
                    } else {
                        return Mono.empty();
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<MinuteForecastResponseInner> getMinuteForecastAsync(ResponseFormat format, String query) {
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public MinuteForecastResponseInner getMinuteForecast(ResponseFormat format, String query) {
        final Integer interval = null;
        final String language = null;
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Response<MinuteForecastResponseInner> getMinuteForecastWithResponse(
        ResponseFormat format, String query, Integer interval, String language, Context context) {
        return getMinuteForecastWithResponseAsync(format, query, interval, language, context).block();
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<Response<QuarterDayForecastResponseInner>> getQuarterDayForecastWithResponseAsync(
        ResponseFormat format, String query, WeatherDataUnit unit, Integer duration, String language) {
        if (this.client.getGeography() == null) {
            return Mono
                .error(
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<QuarterDayForecastResponseInner> getQuarterDayForecastAsync(
        ResponseFormat format, String query, WeatherDataUnit unit, Integer duration, String language) {
        return getQuarterDayForecastWithResponseAsync(format, query, unit, duration, language)
            .flatMap(
                (Response<QuarterDayForecastResponseInner> res) -> {
                    if (res.getValue() != null) {
                        return Mono.just(res.getValue());
                    } else {
                        return Mono.empty();
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<QuarterDayForecastResponseInner> getQuarterDayForecastAsync(ResponseFormat format, String query) {
        final WeatherDataUnit unit = null;
        final Integer duration = null;
        final String language = null;
        return getQuarterDayForecastWithResponseAsync(format, query, unit, duration, language)
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public QuarterDayForecastResponseInner getQuarterDayForecast(ResponseFormat format, String query) {
        final WeatherDataUnit unit = null;
        final Integer duration = null;
        final String language = null;
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Response<QuarterDayForecastResponseInner> getQuarterDayForecastWithResponse(
        ResponseFormat format, String query, WeatherDataUnit unit, Integer duration, String language, Context context) {
        return getQuarterDayForecastWithResponseAsync(format, query, unit, duration, language, context).block();
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<Response<CurrentConditionsResponseInner>> getCurrentConditionsWithResponseAsync(
        ResponseFormat format, String query, WeatherDataUnit unit, String details, Integer duration, String language) {
        if (this.client.getGeography() == null) {
            return Mono
                .error(
                    new IllegalArgumentException(
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<CurrentConditionsResponseInner> getCurrentConditionsAsync(
        ResponseFormat format, String query, WeatherDataUnit unit, String details, Integer duration, String language) {
        return getCurrentConditionsWithResponseAsync(format, query, unit, details, duration, language)
            .flatMap(
                (Response<CurrentConditionsResponseInner> res) -> {
                    if (res.getValue() != null) {
                        return Mono.just(res.getValue());
                    } else {
                        return Mono.empty();
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<CurrentConditionsResponseInner> getCurrentConditionsAsync(ResponseFormat format, String query) {
        final WeatherDataUnit unit = null;
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public CurrentConditionsResponseInner getCurrentConditions(ResponseFormat format, String query) {
        final WeatherDataUnit unit = null;
        final String details = null;
        final Integer duration = null;
        final String language = null;
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Response<CurrentConditionsResponseInner> getCurrentConditionsWithResponse(
        ResponseFormat format,
        String query,
        WeatherDataUnit unit,
        String details,
        ...
        String language,
        Context context) {
        return getCurrentConditionsWithResponseAsync(format, query, unit, details, duration, language, context).block();
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<Response<DailyForecastResponseInner>> getDailyForecastWithResponseAsync(
        ResponseFormat format, String query, WeatherDataUnit unit, Integer duration, String language) {
        if (this.client.getGeography() == null) {
            return Mono
                .error(
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<DailyForecastResponseInner> getDailyForecastAsync(
        ResponseFormat format, String query, WeatherDataUnit unit, Integer duration, String language) {
        return getDailyForecastWithResponseAsync(format, query, unit, duration, language)
            .flatMap(
                (Response<DailyForecastResponseInner> res) -> {
                    if (res.getValue() != null) {
                        return Mono.just(res.getValue());
                    } else {
                        return Mono.empty();
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<DailyForecastResponseInner> getDailyForecastAsync(ResponseFormat format, String query) {
        final WeatherDataUnit unit = null;
        final Integer duration = null;
        final String language = null;
        return getDailyForecastWithResponseAsync(format, query, unit, duration, language)
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public DailyForecastResponseInner getDailyForecast(ResponseFormat format, String query) {
        final WeatherDataUnit unit = null;
        final Integer duration = null;
        final String language = null;
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Response<DailyForecastResponseInner> getDailyForecastWithResponse(
        ResponseFormat format, String query, WeatherDataUnit unit, Integer duration, String language, Context context) {
        return getDailyForecastWithResponseAsync(format, query, unit, duration, language, context).block();
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<Response<WeatherAlongRouteResponseInner>> getWeatherAlongRouteWithResponseAsync(
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<WeatherAlongRouteResponseInner> getWeatherAlongRouteAsync(
        ResponseFormat format, String query, String language) {
        return getWeatherAlongRouteWithResponseAsync(format, query, language)
            .flatMap(
                (Response<WeatherAlongRouteResponseInner> res) -> {
                    if (res.getValue() != null) {
                        return Mono.just(res.getValue());
                    } else {
                        return Mono.empty();
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<WeatherAlongRouteResponseInner> getWeatherAlongRouteAsync(ResponseFormat format, String query) {
        final String language = null;
        return getWeatherAlongRouteWithResponseAsync(format, query, language)
            .flatMap(
                (Response<WeatherAlongRouteResponseInner> res) -> {
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public WeatherAlongRouteResponseInner getWeatherAlongRoute(ResponseFormat format, String query) {
        final String language = null;
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Response<WeatherAlongRouteResponseInner> getWeatherAlongRouteWithResponse(
        ResponseFormat format, String query, String language, Context context) {
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<Response<SevereWeatherAlertsResponseInner>> getSevereWeatherAlertsWithResponseAsync(
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<SevereWeatherAlertsResponseInner> getSevereWeatherAlertsAsync(
        ResponseFormat format, String query, String language, String details) {
        return getSevereWeatherAlertsWithResponseAsync(format, query, language, details)
            .flatMap(
                (Response<SevereWeatherAlertsResponseInner> res) -> {
                    if (res.getValue() != null) {
                        return Mono.just(res.getValue());
                    } else {
                        return Mono.empty();
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<SevereWeatherAlertsResponseInner> getSevereWeatherAlertsAsync(ResponseFormat format, String query) {
        final String language = null;
        final String details = null;
        return getSevereWeatherAlertsWithResponseAsync(format, query, language, details)
            .flatMap(
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public SevereWeatherAlertsResponseInner getSevereWeatherAlerts(ResponseFormat format, String query) {
        final String language = null;
        final String details = null;
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Response<SevereWeatherAlertsResponseInner> getSevereWeatherAlertsWithResponse(
        ResponseFormat format, String query, String language, String details, Context context) {
        return getSevereWeatherAlertsWithResponseAsync(format, query, language, details, context).block();
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<Response<DailyIndicesResponseInner>> getDailyIndicesWithResponseAsync(
        ResponseFormat format, String query, String language, Integer duration, Integer indexId, Integer indexGroupId) {
        if (this.client.getGeography() == null) {
            return Mono
                .error(
                    new IllegalArgumentException(
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<DailyIndicesResponseInner> getDailyIndicesAsync(
        ResponseFormat format, String query, String language, Integer duration, Integer indexId, Integer indexGroupId) {
        return getDailyIndicesWithResponseAsync(format, query, language, duration, indexId, indexGroupId)
            .flatMap(
                (Response<DailyIndicesResponseInner> res) -> {
                    if (res.getValue() != null) {
                        return Mono.just(res.getValue());
                    } else {
                        return Mono.empty();
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<DailyIndicesResponseInner> getDailyIndicesAsync(ResponseFormat format, String query) {
        final String language = null;
        final Integer duration = null;
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public DailyIndicesResponseInner getDailyIndices(ResponseFormat format, String query) {
        final String language = null;
        final Integer duration = null;
        final Integer indexId = null;
        final Integer indexGroupId = null;
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Response<DailyIndicesResponseInner> getDailyIndicesWithResponse(
        ResponseFormat format,
        String query,
        String language,
        Integer duration,
        ...
        Integer indexGroupId,
        Context context) {
        return getDailyIndicesWithResponseAsync(format, query, language, duration, indexId, indexGroupId, context)
            .block();
    }
}
