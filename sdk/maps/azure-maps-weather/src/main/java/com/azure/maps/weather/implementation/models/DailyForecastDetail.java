...
public final class DailyForecastDetail {
     ...
     * @return the DailyForecastDetail object itself.
     */
    public DailyForecastDetail setIconCode(IconCode iconCode) {
     ...
     * @return the DailyForecastDetail object itself.
     */
    public DailyForecastDetail setIconPhrase(String iconPhrase) {
     ...
     * @return the DailyForecastDetail object itself.
     */
    public DailyForecastDetail setLocalSource(LocalSource localSource) {
     ...
     * @return the DailyForecastDetail object itself.
     */
    public DailyForecastDetail setHasPrecipitation(Boolean hasPrecipitation) {
     ...
     * @return the DailyForecastDetail object itself.
     */
    public DailyForecastDetail setPrecipitationType(PrecipitationType precipitationType) {
     ...
     * @return the DailyForecastDetail object itself.
     */
    public DailyForecastDetail setPrecipitationIntensity(String precipitationIntensity) {
    ...
    /**
     * Set the shortDescription property: Phrase description of the forecast in specified language. Azure Maps attempts
     * to keep this phrase under 30 characters in length, but some languages/weather events may result in a longer
     * phrase length, exceeding 30 characters.
     *
     ...
     * @return the DailyForecastDetail object itself.
     */
    public DailyForecastDetail setShortDescription(String shortDescription) {
     ...
     * @return the DailyForecastDetail object itself.
     */
    public DailyForecastDetail setLongPhrase(String longPhrase) {
     ...
     * @return the DailyForecastDetail object itself.
     */
    public DailyForecastDetail setPrecipitationProbability(Integer precipitationProbability) {
     ...
     * @return the DailyForecastDetail object itself.
     */
    public DailyForecastDetail setThunderstormProbability(Integer thunderstormProbability) {
     ...
     * @return the DailyForecastDetail object itself.
     */
    public DailyForecastDetail setRainProbability(Integer rainProbability) {
     ...
     * @return the DailyForecastDetail object itself.
     */
    public DailyForecastDetail setSnowProbability(Integer snowProbability) {
     ...
     * @return the DailyForecastDetail object itself.
     */
    public DailyForecastDetail setIceProbability(Integer iceProbability) {
     ...
     * @return the DailyForecastDetail object itself.
     */
    public DailyForecastDetail setWind(WindDetails wind) {
        this.wind = wind;
        return this;
    }
     ...
     * @return the DailyForecastDetail object itself.
     */
    public DailyForecastDetail setWindGust(WindDetails windGust) {
     ...
     * @return the DailyForecastDetail object itself.
     */
    public DailyForecastDetail setTotalLiquid(WeatherValue totalLiquid) {
     ...
     * @return the DailyForecastDetail object itself.
     */
    public DailyForecastDetail setRain(WeatherValue rain) {
        this.rain = rain;
        return this;
    }
     ...
     * @return the DailyForecastDetail object itself.
     */
    public DailyForecastDetail setSnow(WeatherValue snow) {
        this.snow = snow;
        return this;
    }
     ...
     * @return the DailyForecastDetail object itself.
     */
    public DailyForecastDetail setIce(WeatherValue ice) {
        this.ice = ice;
        return this;
    }
     ...
     * @return the DailyForecastDetail object itself.
     */
    public DailyForecastDetail setHoursOfPrecipitation(Float hoursOfPrecipitation) {
     ...
     * @return the DailyForecastDetail object itself.
     */
    public DailyForecastDetail setHoursOfRain(Float hoursOfRain) {
     ...
     * @return the DailyForecastDetail object itself.
     */
    public DailyForecastDetail setHoursOfSnow(Float hoursOfSnow) {
     ...
     * @return the DailyForecastDetail object itself.
     */
    public DailyForecastDetail setHoursOfIce(Float hoursOfIce) {
     ...
     * @return the DailyForecastDetail object itself.
     */
    public DailyForecastDetail setCloudCover(Integer cloudCover) {
