...
public final class DailyAirQualityForecastResult {
    ...
    /**
     * Set the airQualityResults property: A list of all daily air quality forecasts for the queried location.
     *
     * @param airQualityResults the airQualityResults value to set.
     * @return the DailyAirQualityForecastResult object itself.
     */
    public DailyAirQualityForecastResult setAirQualityResults(List<DailyAirQuality> airQualityResults) {
     ...
     * @return the DailyAirQualityForecastResult object itself.
     */
    public DailyAirQualityForecastResult setNextLink(String nextLink) {
