...
public final class WeatherClientImpl {
    private final ClientLogger logger = new ClientLogger(WeatherClientImpl.class);
     ...
     */
    public WeatherClientImpl(String clientId, String host, String apiVersion) {
        this(
     ...
     * @param apiVersion Api Version.
     */
    public WeatherClientImpl(HttpPipeline httpPipeline, String clientId, String host, String apiVersion) {
    ...
    public WeatherClientImpl(
        ...
        this.service = RestProxy.create(WeatherClientService.class, this.httpPipeline, this.getSerializerAdapter());
    }

    /**
     * The interface defining all the services for WeatherClient to be used by the proxy service to perform REST calls.
     */
    @Host("{$host}")
    @ServiceInterface(name = "WeatherClient")
    private interface WeatherClientService {
    ...
    public Mono<Response<WeatherAlongRouteResponse>> getWeatherAlongRouteWithResponseAsync(
        ...
        return service.getWeatherAlongRoute(
                this.getHost(), this.getClientId(), this.getApiVersion(), format, query, language, accept);
    }
