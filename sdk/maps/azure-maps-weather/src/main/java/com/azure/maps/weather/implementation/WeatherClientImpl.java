...
/** Initializes a new instance of the WeatherClientImpl type. */
@ServiceClient(builder = WeatherClientBuilder.class)
public final class WeatherClientImpl implements WeatherClient {
    ...
    /** The WeathersClient object to access its operations. */
    private final WeathersClient weathers;

    /**
     * Gets the WeathersClient object to access its operations.
     *
     * @return the WeathersClient object.
     */
    public WeathersClient getWeathers() {
    ...
    WeatherClientImpl(
        ...
        this.apiVersion = "1.0";
        this.weathers = new WeathersClientImpl(this);
    }
