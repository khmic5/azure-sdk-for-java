...
public final class WeatherClientImpl {
     ...
     */
    public WeatherClientImpl(String xMsClientId, Geography geography, String apiVersion) {
        this(
     ...
     * @param apiVersion Api Version.
     */
    public WeatherClientImpl(HttpPipeline httpPipeline, String xMsClientId, Geography geography, String apiVersion) {
