...
@Fluent
public final class StormSearchResultItem {
    /*
     * Year of origination
     */
     ...
     * @return the StormSearchResultItem object itself.
     */
    public StormSearchResultItem setBasinId(BasinId basinId) {
     ...
     * @return the StormSearchResultItem object itself.
     */
    public StormSearchResultItem setName(String name) {
        this.name = name;
        return this;
    }
     ...
     * @return the StormSearchResultItem object itself.
     */
    public StormSearchResultItem setIsActive(Boolean isActive) {
    ...
    /**
     * Set the isRetired property: True if the storm name has been permanently retired in the source basin.
     *
     * @param isRetired the isRetired value to set.
     * @return the StormSearchResultItem object itself.
     */
    public StormSearchResultItem setIsRetired(Boolean isRetired) {
     ...
     * @return the StormSearchResultItem object itself.
     */
    public StormSearchResultItem setIsSubtropical(Boolean isSubtropical) {
     ...
     * @return the StormSearchResultItem object itself.
     */
    public StormSearchResultItem setGovId(Integer govId) {
        this.govId = govId;
        return this;
    }
}
