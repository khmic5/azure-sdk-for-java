...
import com.azure.maps.render.implementation.RenderV2sClientImpl;
...
public final class RenderV2Client {
    private final RenderV2sClientImpl serviceClient;

    /**
     * Initializes an instance of RenderV2sClient client.
     *
     * @param serviceClient the service client implementation.
     */
    public RenderV2Client(RenderV2sClientImpl serviceClient) {
    ...
    public Response<MapTilesetResultV2Inner> getMapTilesetWithResponse(TilesetId tilesetId, Context context) {
        return this.serviceClient.getMapTilesetWithResponse(tilesetId, context);
    }
    ...
    public Response<MapAttributionResultV2Inner> getMapAttributionWithResponse(
        ...
        return this.serviceClient.getMapAttributionWithResponse(tilesetId, zoom, bounds, context);
    }
}
