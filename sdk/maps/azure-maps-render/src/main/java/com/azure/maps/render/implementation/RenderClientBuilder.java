...
/** A builder for creating a new instance of the RenderClientImpl type. */
...
public final class RenderClientBuilder {
     ...
     * @return the RenderClientBuilder.
     */
    public RenderClientBuilder environment(AzureEnvironment environment) {
     ...
     * @return the RenderClientBuilder.
     */
    public RenderClientBuilder defaultPollInterval(Duration defaultPollInterval) {
