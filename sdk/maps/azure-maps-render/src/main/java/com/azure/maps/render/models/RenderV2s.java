...
/** Resource collection API of RenderV2s. */
public interface RenderV2s {
    /**
     ...
     */
    MapTilesetResultV2 getMapTileset(TilesetId tilesetId);
     ...
     * @return metadata for a tileset in the TileJSON format.
     */
    Response<MapTilesetResultV2> getMapTilesetWithResponse(TilesetId tilesetId, Context context);
     ...
     */
    MapAttributionResultV2 getMapAttribution(TilesetId tilesetId, int zoom, List<String> bounds);
     ...
     * @return copyright attribution for the requested section of a tileset.
     */
    Response<MapAttributionResultV2> getMapAttributionWithResponse(
