...
@Immutable
public final class GetCopyrightFromBoundingBoxResultInner {
    @JsonIgnore private final ClientLogger logger = new ClientLogger(GetCopyrightFromBoundingBoxResultInner.class);
