...
public final class TileIndex {
    ...
    /**
     * Get the x property: X coordinate of the tile on zoom grid. Value must be
     * in the range [0, 2&lt;sup&gt;`zoom`&lt;/sup&gt; -1].
     * 
     * Please see [Zoom Levels and Tile
     * Grid](https://docs.microsoft.com/azure/location-based-services/zoom-levels-and-tile-grid)
     * for details.
    ...
    /**
     * Set the x property: X coordinate of the tile on zoom grid. Value must be
     * in the range [0, 2&lt;sup&gt;`zoom`&lt;/sup&gt; -1].
     * 
     * Please see [Zoom Levels and Tile
     * Grid](https://docs.microsoft.com/azure/location-based-services/zoom-levels-and-tile-grid)
    ...
    /**
     * Get the y property: Y coordinate of the tile on zoom grid. Value must be
     * in the range [0, 2&lt;sup&gt;`zoom`&lt;/sup&gt; -1].
     * 
     * Please see [Zoom Levels and Tile
     * Grid](https://docs.microsoft.com/azure/location-based-services/zoom-levels-and-tile-grid)
    ...
    /**
     * Set the y property: Y coordinate of the tile on zoom grid. Value must be
     * in the range [0, 2&lt;sup&gt;`zoom`&lt;/sup&gt; -1].
     * 
     * Please see [Zoom Levels and Tile
     * Grid](https://docs.microsoft.com/azure/location-based-services/zoom-levels-and-tile-grid)
