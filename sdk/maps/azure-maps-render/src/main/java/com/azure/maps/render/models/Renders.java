...
/** Resource collection API of Renders. */
public interface Renders {
     ...
     */
    GetCopyrightCaptionResult getCopyrightCaption(TextFormat format);
     ...
     * @return this object is returned from a successful Get Copyright Caption call.
     */
    Response<GetCopyrightCaptionResult> getCopyrightCaptionWithResponse(TextFormat format, Context context);
     ...
     */
    GetCopyrightFromBoundingBoxResult getCopyrightFromBoundingBox(
     ...
     * @return this object is returned from a successful Get Copyright From Bounding Box call.
     */
    Response<GetCopyrightFromBoundingBoxResult> getCopyrightFromBoundingBoxWithResponse(
     ...
     */
    GetCopyrightForTileResult getCopyrightForTile(TextFormat format, int zoom, int xTileIndex, int yTileIndex);
     ...
     * @return this object is returned from a successful Get Copyright For Tile call.
     */
    Response<GetCopyrightForTileResult> getCopyrightForTileWithResponse(
     ...
     */
    GetCopyrightForWorldResult getCopyrightForWorld(TextFormat format);
     ...
     * @return this object is returned from a successful Get Copyright For World call.
     */
    Response<GetCopyrightForWorldResult> getCopyrightForWorldWithResponse(
