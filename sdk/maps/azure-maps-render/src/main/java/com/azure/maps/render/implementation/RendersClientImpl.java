...
/** An instance of this class provides access to all the operations defined in RendersClient. */
public final class RendersClientImpl implements RendersClient {
    private final ClientLogger logger = new ClientLogger(RendersClientImpl.class);
    ...
    /**
     * Initializes an instance of RendersClientImpl.
     *
     * @param client the instance of the service client containing this operation class.
     */
    RendersClientImpl(RenderClientImpl client) {
    ...
    private interface RendersService {
        ...
        @ExpectedResponses({200})
        @UnexpectedResponseExceptionType(ManagementException.class)
        Mono<Response<GetCopyrightCaptionResultInner>> getCopyrightCaption(
            @HostParam("geography") Geography geography,
            @HeaderParam("x-ms-client-id") String xMsClientId,
            @QueryParam("api-version") String apiVersion,
        ...
        @ExpectedResponses({200})
        @UnexpectedResponseExceptionType(ManagementException.class)
        Mono<Response<GetCopyrightFromBoundingBoxResultInner>> getCopyrightFromBoundingBox(
            @HostParam("geography") Geography geography,
            @HeaderParam("x-ms-client-id") String xMsClientId,
            @QueryParam("api-version") String apiVersion,
            @PathParam("format") TextFormat format,
        ...
        @ExpectedResponses({200})
        @UnexpectedResponseExceptionType(ManagementException.class)
        Mono<Response<GetCopyrightForTileResultInner>> getCopyrightForTile(
            @HostParam("geography") Geography geography,
            @HeaderParam("x-ms-client-id") String xMsClientId,
            @QueryParam("api-version") String apiVersion,
            @PathParam("format") TextFormat format,
        ...
        @ExpectedResponses({200})
        @UnexpectedResponseExceptionType(ManagementException.class)
        Mono<Response<GetCopyrightForWorldResultInner>> getCopyrightForWorld(
            @HostParam("geography") Geography geography,
            @HeaderParam("x-ms-client-id") String xMsClientId,
            @QueryParam("api-version") String apiVersion,
            @PathParam("format") TextFormat format,
    ...
    private Mono<StreamResponse> getMapStaticImageWithResponseAsync(
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Flux<ByteBuffer> getMapStaticImageAsync(
        RasterTileFormat format,
        StaticMapLayer layer,
        MapImageStyle style,
        Integer zoom,
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Flux<ByteBuffer> getMapStaticImageAsync(RasterTileFormat format) {
    ...
    public InputStream getMapStaticImage(RasterTileFormat format) {
        ...
        Iterator<ByteBufferBackedInputStream> iterator =
            getMapStaticImageAsync(format, layer, style, zoom, center, bbox, height, width, language, view, pins, path)
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<StreamResponse> getMapTileWithResponseAsync(
        TileFormat format,
        MapTileLayer layer,
        MapTileStyle style,
        int zoom,
        ...
        if (layer == null) {
            return Mono.error(new IllegalArgumentException("Parameter layer is required and cannot be null."));
        }
        if (style == null) {
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Flux<ByteBuffer> getMapTileAsync(
        TileFormat format,
        MapTileLayer layer,
        MapTileStyle style,
        int zoom,
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<StreamResponse> getMapStateTilePreviewWithResponseAsync(
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Flux<ByteBuffer> getMapStateTilePreviewAsync(int zoom, int xTileIndex, int yTileIndex, String statesetId) {
    ...
    public StreamResponse getMapStateTilePreviewWithResponse(
        int zoom, int xTileIndex, int yTileIndex, String statesetId, Context context) {
        return getMapStateTilePreviewWithResponseAsync(zoom, xTileIndex, yTileIndex, statesetId, context).block();
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<Response<GetCopyrightCaptionResultInner>> getCopyrightCaptionWithResponseAsync(TextFormat format) {
        if (this.client.getGeography() == null) {
            return Mono
                .error(
                    new IllegalArgumentException(
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<Response<GetCopyrightCaptionResultInner>> getCopyrightCaptionWithResponseAsync(
        TextFormat format, Context context) {
        if (this.client.getGeography() == null) {
            return Mono
                .error(
                    new IllegalArgumentException(
        ...
        return service
            .getCopyrightCaption(
                this.client.getGeography(), this.client.getXMsClientId(), apiVersion, format, accept, context);
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<GetCopyrightCaptionResultInner> getCopyrightCaptionAsync(TextFormat format) {
        return getCopyrightCaptionWithResponseAsync(format)
            .flatMap(
                (Response<GetCopyrightCaptionResultInner> res) -> {
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public GetCopyrightCaptionResultInner getCopyrightCaption(TextFormat format) {
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Response<GetCopyrightCaptionResultInner> getCopyrightCaptionWithResponse(
        TextFormat format, Context context) {
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<StreamResponse> getMapImageryTileWithResponseAsync(
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Flux<ByteBuffer> getMapImageryTileAsync(
        RasterTileFormat format, MapImageryStyle style, int zoom, int xTileIndex, int yTileIndex) {
    ...
    public StreamResponse getMapImageryTileWithResponse(
        RasterTileFormat format, MapImageryStyle style, int zoom, int xTileIndex, int yTileIndex, Context context) {
        return getMapImageryTileWithResponseAsync(format, style, zoom, xTileIndex, yTileIndex, context).block();
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<Response<GetCopyrightFromBoundingBoxResultInner>> getCopyrightFromBoundingBoxWithResponseAsync(
        ...
        if (mincoordinates == null) {
            return Mono.error(new IllegalArgumentException("Parameter mincoordinates is required and cannot be null."));
        }
        if (maxcoordinates == null) {
            return Mono.error(new IllegalArgumentException("Parameter maxcoordinates is required and cannot be null."));
        }
        final String apiVersion = "1.0";
        final String accept = "application/json";
        return FluxUtil
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<GetCopyrightFromBoundingBoxResultInner> getCopyrightFromBoundingBoxAsync(
        TextFormat format, String mincoordinates, String maxcoordinates, IncludeText text) {
        return getCopyrightFromBoundingBoxWithResponseAsync(format, mincoordinates, maxcoordinates, text)
            .flatMap(
                (Response<GetCopyrightFromBoundingBoxResultInner> res) -> {
                    if (res.getValue() != null) {
                        return Mono.just(res.getValue());
                    } else {
                        return Mono.empty();
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public GetCopyrightFromBoundingBoxResultInner getCopyrightFromBoundingBox(
        TextFormat format, String mincoordinates, String maxcoordinates) {
        final IncludeText text = null;
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Response<GetCopyrightFromBoundingBoxResultInner> getCopyrightFromBoundingBoxWithResponse(
        TextFormat format, String mincoordinates, String maxcoordinates, IncludeText text, Context context) {
        return getCopyrightFromBoundingBoxWithResponseAsync(format, mincoordinates, maxcoordinates, text, context)
            .block();
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<Response<GetCopyrightForTileResultInner>> getCopyrightForTileWithResponseAsync(
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<GetCopyrightForTileResultInner> getCopyrightForTileAsync(
        TextFormat format, int zoom, int xTileIndex, int yTileIndex, IncludeText text) {
        return getCopyrightForTileWithResponseAsync(format, zoom, xTileIndex, yTileIndex, text)
            .flatMap(
                (Response<GetCopyrightForTileResultInner> res) -> {
                    if (res.getValue() != null) {
                        return Mono.just(res.getValue());
                    } else {
                        return Mono.empty();
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public GetCopyrightForTileResultInner getCopyrightForTile(
        TextFormat format, int zoom, int xTileIndex, int yTileIndex) {
        final IncludeText text = null;
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Response<GetCopyrightForTileResultInner> getCopyrightForTileWithResponse(
        TextFormat format, int zoom, int xTileIndex, int yTileIndex, IncludeText text, Context context) {
        return getCopyrightForTileWithResponseAsync(format, zoom, xTileIndex, yTileIndex, text, context).block();
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<Response<GetCopyrightForWorldResultInner>> getCopyrightForWorldWithResponseAsync(
    ...
    private Mono<Response<GetCopyrightForWorldResultInner>> getCopyrightForWorldWithResponseAsync(
        ...
        return service
            .getCopyrightForWorld(
                this.client.getGeography(), this.client.getXMsClientId(), apiVersion, format, text, accept, context);
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<GetCopyrightForWorldResultInner> getCopyrightForWorldAsync(TextFormat format, IncludeText text) {
        return getCopyrightForWorldWithResponseAsync(format, text)
            .flatMap(
                (Response<GetCopyrightForWorldResultInner> res) -> {
                    if (res.getValue() != null) {
                        return Mono.just(res.getValue());
                    } else {
                        return Mono.empty();
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<GetCopyrightForWorldResultInner> getCopyrightForWorldAsync(TextFormat format) {
        final IncludeText text = null;
        return getCopyrightForWorldWithResponseAsync(format, text)
            .flatMap(
                (Response<GetCopyrightForWorldResultInner> res) -> {
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public GetCopyrightForWorldResultInner getCopyrightForWorld(TextFormat format) {
        final IncludeText text = null;
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Response<GetCopyrightForWorldResultInner> getCopyrightForWorldWithResponse(
        TextFormat format, IncludeText text, Context context) {
        return getCopyrightForWorldWithResponseAsync(format, text, context).block();
    }
}
