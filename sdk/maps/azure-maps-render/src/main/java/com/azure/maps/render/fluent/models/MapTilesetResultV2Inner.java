...
@Fluent
public final class MapTilesetResultV2Inner {
    @JsonIgnore private final ClientLogger logger = new ClientLogger(MapTilesetResultV2Inner.class);
     ...
     * @return the MapTilesetResultV2Inner object itself.
     */
    public MapTilesetResultV2Inner withTilejson(String tilejson) {
     ...
     * @return the MapTilesetResultV2Inner object itself.
     */
    public MapTilesetResultV2Inner withName(String name) {
        this.name = name;
        return this;
    }
     ...
     * @return the MapTilesetResultV2Inner object itself.
     */
    public MapTilesetResultV2Inner withDescription(String description) {
     ...
     * @return the MapTilesetResultV2Inner object itself.
     */
    public MapTilesetResultV2Inner withVersion(String version) {
     ...
     * @return the MapTilesetResultV2Inner object itself.
     */
    public MapTilesetResultV2Inner withAttribution(String attribution) {
     ...
     * @return the MapTilesetResultV2Inner object itself.
     */
    public MapTilesetResultV2Inner withTemplate(String template) {
     ...
     * @return the MapTilesetResultV2Inner object itself.
     */
    public MapTilesetResultV2Inner withLegend(String legend) {
        this.legend = legend;
        return this;
    }
     ...
     * @return the MapTilesetResultV2Inner object itself.
     */
    public MapTilesetResultV2Inner withScheme(String scheme) {
        this.scheme = scheme;
        return this;
    }
     ...
     * @return the MapTilesetResultV2Inner object itself.
     */
    public MapTilesetResultV2Inner withTiles(List<String> tiles) {
        this.tiles = tiles;
        return this;
    }
     ...
     * @return the MapTilesetResultV2Inner object itself.
     */
    public MapTilesetResultV2Inner withGrids(List<String> grids) {
        this.grids = grids;
        return this;
    }
     ...
     * @return the MapTilesetResultV2Inner object itself.
     */
    public MapTilesetResultV2Inner withData(List<String> data) {
        this.data = data;
        return this;
    }
     ...
     * @return the MapTilesetResultV2Inner object itself.
     */
    public MapTilesetResultV2Inner withMinzoom(Integer minzoom) {
     ...
     * @return the MapTilesetResultV2Inner object itself.
     */
    public MapTilesetResultV2Inner withMaxzoom(Integer maxzoom) {
     ...
     * @return the MapTilesetResultV2Inner object itself.
     */
    public MapTilesetResultV2Inner withBounds(List<Float> bounds) {
        this.bounds = bounds;
        return this;
    }
     ...
     * @return the MapTilesetResultV2Inner object itself.
     */
    public MapTilesetResultV2Inner withCenter(List<Float> center) {
        this.center = center;
        return this;
    }
