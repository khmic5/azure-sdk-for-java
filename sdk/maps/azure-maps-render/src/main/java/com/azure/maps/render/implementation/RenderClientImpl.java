...
public final class RenderClientImpl {
    ...
    RenderClientImpl(String clientId, String host, String apiVersion) {
        this(new HttpPipelineBuilder().policies(new UserAgentPolicy(), new RetryPolicy(), new CookiePolicy()).build(), JacksonAdapter.createDefaultSerializerAdapter(), clientId, host, apiVersion);
    }
     ...
     * @param apiVersion Api Version.
     */
    RenderClientImpl(HttpPipeline httpPipeline, SerializerAdapter serializerAdapter, String clientId, String host, String apiVersion) {
