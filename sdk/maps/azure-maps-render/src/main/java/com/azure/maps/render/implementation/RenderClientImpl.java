...
/** Initializes a new instance of the RenderClientImpl type. */
@ServiceClient(builder = RenderClientBuilder.class)
public final class RenderClientImpl implements RenderClient {
    ...
    /** The RendersClient object to access its operations. */
    private final RendersClient renders;
     ...
     */
    public RendersClient getRenders() {
        return this.renders;
    }

    /** The RenderV2sClient object to access its operations. */
    private final RenderV2sClient renderV2s;
     ...
     */
    public RenderV2sClient getRenderV2s() {
