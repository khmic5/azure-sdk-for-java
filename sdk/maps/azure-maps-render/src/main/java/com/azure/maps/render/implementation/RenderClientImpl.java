...
public final class RenderClientImpl {
    ...
    private final RenderClientService service;
     ...
     */
    public RenderClientImpl(String clientId, String host, String apiVersion) {
        this(
     ...
     * @param apiVersion Api Version.
     */
    public RenderClientImpl(HttpPipeline httpPipeline, String clientId, String host, String apiVersion) {
    ...
    public RenderClientImpl(
        ...
        this.service = RestProxy.create(RenderClientService.class, this.httpPipeline, this.getSerializerAdapter());
    }

    /**
     * The interface defining all the services for RenderClient to be used by the proxy service to perform REST calls.
     */
    @Host("{$host}")
    @ServiceInterface(name = "RenderClient")
    private interface RenderClientService {
        @Get("/map/tile")
        @ExpectedResponses({200})
        @UnexpectedResponseExceptionType(ErrorResponseException.class)
        Mono<StreamResponse> getMapTileV2(
    ...
    public Mono<StreamResponse> getMapTileV2WithResponseAsync(
            TilesetID tilesetId,
            TileIndex tileIndex,
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Flux<ByteBuffer> getMapTileV2Async(
            TilesetID tilesetId,
            TileIndex tileIndex,
            OffsetDateTime timeStamp,
            MapTileSize tileSize,
            String language,
            LocalizedMapView localizedMapView) {
        return getMapTileV2WithResponseAsync(tilesetId, tileIndex, timeStamp, tileSize, language, localizedMapView)
    ...
    public InputStream getMapTileV2(
        ...
        Iterator<ByteBufferBackedInputStream> iterator =
                getMapTileV2Async(tilesetId, tileIndex, timeStamp, tileSize, language, localizedMapView)
    ...
    public Mono<Response<MapTileset>> getMapTilesetWithResponseAsync(TilesetID tilesetId) {
        ...
        return service.getMapTileset(this.getHost(), this.getClientId(), this.getApiVersion(), tilesetId, accept);
    }
    ...
    public Mono<Response<MapAttribution>> getMapAttributionWithResponseAsync(
        ...
        return service.getMapAttribution(
                this.getHost(), this.getClientId(), this.getApiVersion(), tilesetId, zoom, boundsConverted, accept);
    }
    ...
    public Mono<StreamResponse> getMapStateTileWithResponseAsync(String statesetId, TileIndex tileIndex) {
        ...
        return service.getMapStateTile(
                this.getHost(), this.getClientId(), this.getApiVersion(), z, x, y, statesetId, accept);
    }
    ...
    public Mono<Response<CopyrightCaption>> getCopyrightCaptionWithResponseAsync(ResponseFormat format) {
        final String accept = "application/json";
        return service.getCopyrightCaption(this.getHost(), this.getClientId(), this.getApiVersion(), format, accept);
    }
    ...
    public Mono<Response<Copyright>> getCopyrightForTileWithResponseAsync(
        ...
        return service.getCopyrightForTile(
                this.getHost(), this.getClientId(), this.getApiVersion(), z, x, y, format, includeText, accept);
    }
    ...
    public Mono<Response<Copyright>> getCopyrightForWorldWithResponseAsync(
        ...
        return service.getCopyrightForWorld(
                this.getHost(), this.getClientId(), this.getApiVersion(), format, includeText, accept);
    }
