...
public final class RenderV2sGetMapStaticImageResponse extends ResponseBase<RenderV2sGetMapStaticImageHeaders, Void> {
     ...
     */
    public RenderV2sGetMapStaticImageResponse(HttpRequest request, int statusCode, HttpHeaders rawHeaders, Void value, RenderV2sGetMapStaticImageHeaders headers) {
