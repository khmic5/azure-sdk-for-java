...
public final class RenderV2sImpl {
    ...
    RenderV2sImpl(RenderClientImpl client) {
        this.service = RestProxy.create(RenderV2sService.class, client.getHttpPipeline(), client.getSerializerAdapter());
        this.client = client;
    }

    /**
     * The interface defining all the services for RenderClientRenderV2s to be
    ...
    private interface RenderV2sService {
        ...
        Mono<StreamResponse> getMapTile(@HostParam("$host") String host, @HeaderParam("x-ms-client-id") String clientId, @QueryParam("api-version") String apiVersion, @QueryParam("tilesetId") TilesetID tilesetId, @QueryParam("zoom") int z, @QueryParam("x") int x, @QueryParam("y") int y, @QueryParam("timeStamp") OffsetDateTime timeStamp, @QueryParam("tileSize") MapTileSize tileSize, @QueryParam("language") String language, @QueryParam("view") LocalizedMapView localizedMapView, @HeaderParam("Accept") String accept, Context context);

        @Get("/map/tileset")
        @ExpectedResponses({200})
        @UnexpectedResponseExceptionType(ErrorResponseException.class)
        Mono<Response<MapTileset>> getMapTileset(@HostParam("$host") String host, @HeaderParam("x-ms-client-id") String clientId, @QueryParam("api-version") String apiVersion, @QueryParam("tilesetId") TilesetID tilesetId, @HeaderParam("Accept") String accept, Context context);

        @Get("/map/attribution")
        @ExpectedResponses({200})
        @UnexpectedResponseExceptionType(ErrorResponseException.class)
        Mono<Response<MapAttribution>> getMapAttribution(@HostParam("$host") String host, @HeaderParam("x-ms-client-id") String clientId, @QueryParam("api-version") String apiVersion, @QueryParam("tilesetId") TilesetID tilesetId, @QueryParam("zoom") int zoom, @QueryParam("bounds") String bounds, @HeaderParam("Accept") String accept, Context context);

        @Get("/map/statetile")
        @ExpectedResponses({200})
        @UnexpectedResponseExceptionType(ErrorResponseException.class)
        Mono<StreamResponse> getMapStateTile(@HostParam("$host") String host, @HeaderParam("x-ms-client-id") String clientId, @QueryParam("api-version") String apiVersion, @QueryParam("zoom") int z, @QueryParam("x") int x, @QueryParam("y") int y, @QueryParam("statesetId") String statesetId, @HeaderParam("Accept") String accept, Context context);

        @Get("/map/copyright/caption/{format}")
        @ExpectedResponses({200})
        @UnexpectedResponseExceptionType(ErrorResponseException.class)
        Mono<Response<CopyrightCaption>> getCopyrightCaption(@HostParam("$host") String host, @HeaderParam("x-ms-client-id") String clientId, @QueryParam("api-version") String apiVersion, @PathParam("format") ResponseFormat format, @HeaderParam("Accept") String accept, Context context);

        @Get("/map/static/{format}")
        @ExpectedResponses({200})
        @UnexpectedResponseExceptionType(ErrorResponseException.class)
        Mono<StreamResponse> getMapStaticImage(@HostParam("$host") String host, @HeaderParam("x-ms-client-id") String clientId, @QueryParam("api-version") String apiVersion, @PathParam("format") RasterTileFormat format, @QueryParam("layer") StaticMapLayer layer, @QueryParam("style") MapImageStyle style, @QueryParam("zoom") Integer zoom, @QueryParam("center") String center, @QueryParam("bbox") String boundingBoxPrivate, @QueryParam("height") Integer height, @QueryParam("width") Integer width, @QueryParam("language") String language, @QueryParam("view") LocalizedMapView localizedMapView, @QueryParam(value = "pins", multipleQueryParams = true) List<String> pins, @QueryParam(value = "path", multipleQueryParams = true) List<String> path, @HeaderParam("Accept") String accept, Context context);

        @Get("/map/copyright/bounding/{format}")
        @ExpectedResponses({200})
        @UnexpectedResponseExceptionType(ErrorResponseException.class)
        Mono<Response<Copyright>> getCopyrightFromBoundingBox(@HostParam("$host") String host, @HeaderParam("x-ms-client-id") String clientId, @QueryParam("api-version") String apiVersion, @QueryParam("mincoordinates") String southWest, @QueryParam("maxcoordinates") String northEast, @PathParam("format") ResponseFormat format, @QueryParam("text") IncludeText includeText, @HeaderParam("Accept") String accept, Context context);

        @Get("/map/copyright/tile/{format}")
        @ExpectedResponses({200})
        @UnexpectedResponseExceptionType(ErrorResponseException.class)
        Mono<Response<Copyright>> getCopyrightForTile(@HostParam("$host") String host, @HeaderParam("x-ms-client-id") String clientId, @QueryParam("api-version") String apiVersion, @QueryParam("zoom") int z, @QueryParam("x") int x, @QueryParam("y") int y, @PathParam("format") ResponseFormat format, @QueryParam("text") IncludeText includeText, @HeaderParam("Accept") String accept, Context context);

        @Get("/map/copyright/world/{format}")
        @ExpectedResponses({200})
        @UnexpectedResponseExceptionType(ErrorResponseException.class)
        Mono<Response<Copyright>> getCopyrightForWorld(@HostParam("$host") String host, @HeaderParam("x-ms-client-id") String clientId, @QueryParam("api-version") String apiVersion, @PathParam("format") ResponseFormat format, @QueryParam("text") IncludeText includeText, @HeaderParam("Accept") String accept, Context context);
    }
     ...
     * @param language Language in which search results should be returned. Should be one of supported IETF language tags, case insensitive. When data in specified language is not available for a specific field, default language is used.
     * 
     * Please refer to [Supported Languages](https://docs.microsoft.com/azure/azure-maps/supported-languages) for details.
     * @param localizedMapView The View parameter (also called the "user region" parameter) allows you to show the correct maps for a certain country/region for geopolitically disputed regions. Different countries have different views of such regions, and the View parameter allows your application to comply with the view required by the country your application will be serving. By default, the View parameter is set to “Unified” even if you haven’t defined it in  the request. It is your responsibility to determine the location of your users, and then set the View parameter correctly for that location. Alternatively, you have the option to set ‘View=Auto’, which will return the map data based on the IP  address of the request. The View parameter in Azure Maps must be used in compliance with applicable laws, including those  regarding mapping, of the country where maps, images and other data and third party content that you are authorized to  access via Azure Maps is made available. Example: view=IN.
     * 
    ...
    public Mono<StreamResponse> getMapTileWithResponseAsync(TilesetID tilesetId, TileIndex tileIndex, OffsetDateTime timeStamp, MapTileSize tileSize, String language, LocalizedMapView localizedMapView) {
        ...
        return FluxUtil.withContext(context -> service.getMapTile(this.client.getHost(), this.client.getClientId(), this.client.getApiVersion(), tilesetId, z, x, y, timeStamp, tileSize, language, localizedMapView, accept, context));
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Mono<StreamResponse> getMapTileWithResponseAsync(TilesetID tilesetId, TileIndex tileIndex, OffsetDateTime timeStamp, MapTileSize tileSize, String language, LocalizedMapView localizedMapView, Context context) {
        final String accept = "application/json, image/jpeg, image/png, image/pbf, application/vnd.mapbox-vector-tile";
        int z = tileIndex.getZ();
        int x = tileIndex.getX();
        int y = tileIndex.getY();
        return service.getMapTile(this.client.getHost(), this.client.getClientId(), this.client.getApiVersion(), tilesetId, z, x, y, timeStamp, tileSize, language, localizedMapView, accept, context);
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Flux<ByteBuffer> getMapTileAsync(TilesetID tilesetId, TileIndex tileIndex, OffsetDateTime timeStamp, MapTileSize tileSize, String language, LocalizedMapView localizedMapView) {
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Flux<ByteBuffer> getMapTileAsync(TilesetID tilesetId, TileIndex tileIndex, OffsetDateTime timeStamp, MapTileSize tileSize, String language, LocalizedMapView localizedMapView, Context context) {
        return getMapTileWithResponseAsync(tilesetId, tileIndex, timeStamp, tileSize, language, localizedMapView, context)
            .flatMapMany(StreamResponse::getValue);}
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public InputStream getMapTile(TilesetID tilesetId, TileIndex tileIndex, OffsetDateTime timeStamp, MapTileSize tileSize, String language, LocalizedMapView localizedMapView) {
        Iterator<ByteBufferBackedInputStream> iterator = getMapTileAsync(tilesetId, tileIndex, timeStamp, tileSize, language, localizedMapView).map(ByteBufferBackedInputStream::new).toStream().iterator();
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public StreamResponse getMapTileWithResponse(TilesetID tilesetId, TileIndex tileIndex, OffsetDateTime timeStamp, MapTileSize tileSize, String language, LocalizedMapView localizedMapView, Context context) {
        return getMapTileWithResponseAsync(tilesetId, tileIndex, timeStamp, tileSize, language, localizedMapView, context).block();
    }
    ...
    public Mono<Response<MapTileset>> getMapTilesetWithResponseAsync(TilesetID tilesetId) {
        ...
        return FluxUtil.withContext(context -> service.getMapTileset(this.client.getHost(), this.client.getClientId(), this.client.getApiVersion(), tilesetId, accept, context));
    }
    ...
    public Mono<Response<MapTileset>> getMapTilesetWithResponseAsync(TilesetID tilesetId, Context context) {
        final String accept = "application/json";
        return service.getMapTileset(this.client.getHost(), this.client.getClientId(), this.client.getApiVersion(), tilesetId, accept, context);
    }
    ...
    public Mono<MapTileset> getMapTilesetAsync(TilesetID tilesetId) {
        return getMapTilesetWithResponseAsync(tilesetId)
            .flatMap((Response<MapTileset> res) -> {
     ...
     * @param bounds The string that represents the rectangular area of a bounding box. The bounds parameter is defined by the 4 bounding box coordinates, with WGS84 longitude and latitude of the southwest corner followed by  WGS84 longitude and latitude of the northeast corner. The string is presented in the following  format: `[SouthwestCorner_Longitude, SouthwestCorner_Latitude, NortheastCorner_Longitude,  NortheastCorner_Latitude]`.
     * @throws IllegalArgumentException thrown if parameters fail the validation.
     * @throws ErrorResponseException thrown if the request is rejected by server.
     * @throws RuntimeException all other wrapped checked exceptions if the request fails to be sent.
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Mono<Response<MapAttribution>> getMapAttributionWithResponseAsync(TilesetID tilesetId, int zoom, List<Double> bounds) {
        final String accept = "application/json";
        String boundsConverted = JacksonAdapter.createDefaultSerializerAdapter().serializeList(bounds, CollectionFormat.CSV);
        return FluxUtil.withContext(context -> service.getMapAttribution(this.client.getHost(), this.client.getClientId(), this.client.getApiVersion(), tilesetId, zoom, boundsConverted, accept, context));
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Mono<Response<MapAttribution>> getMapAttributionWithResponseAsync(TilesetID tilesetId, int zoom, List<Double> bounds, Context context) {
        final String accept = "application/json";
        String boundsConverted = JacksonAdapter.createDefaultSerializerAdapter().serializeList(bounds, CollectionFormat.CSV);
        return service.getMapAttribution(this.client.getHost(), this.client.getClientId(), this.client.getApiVersion(), tilesetId, zoom, boundsConverted, accept, context);
    }
    ...
    public Mono<MapAttribution> getMapAttributionAsync(TilesetID tilesetId, int zoom, List<Double> bounds) {
        return getMapAttributionWithResponseAsync(tilesetId, zoom, bounds)
            .flatMap((Response<MapAttribution> res) -> {
                if (res.getValue() != null) {
                    return Mono.just(res.getValue());
                } else {
                    return Mono.empty();
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Mono<MapAttribution> getMapAttributionAsync(TilesetID tilesetId, int zoom, List<Double> bounds, Context context) {
    ...
    public Mono<StreamResponse> getMapStateTileWithResponseAsync(String statesetId, TileIndex tileIndex) {
        ...
        int x = tileIndex.getX();
        int y = tileIndex.getY();
        return FluxUtil.withContext(context -> service.getMapStateTile(this.client.getHost(), this.client.getClientId(), this.client.getApiVersion(), z, x, y, statesetId, accept, context));
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Mono<StreamResponse> getMapStateTileWithResponseAsync(String statesetId, TileIndex tileIndex, Context context) {
        final String accept = "application/vnd.mapbox-vector-tile, application/json";
        int z = tileIndex.getZ();
        int x = tileIndex.getX();
        int y = tileIndex.getY();
        return service.getMapStateTile(this.client.getHost(), this.client.getClientId(), this.client.getApiVersion(), z, x, y, statesetId, accept, context);
    }
    ...
    public Flux<ByteBuffer> getMapStateTileAsync(String statesetId, TileIndex tileIndex) {
        return getMapStateTileWithResponseAsync(statesetId, tileIndex)
            .flatMapMany(StreamResponse::getValue);}
    ...
    public InputStream getMapStateTile(String statesetId, TileIndex tileIndex) {
        Iterator<ByteBufferBackedInputStream> iterator = getMapStateTileAsync(statesetId, tileIndex).map(ByteBufferBackedInputStream::new).toStream().iterator();
        Enumeration<InputStream> enumeration = new Enumeration<InputStream>() {
            @Override
            public boolean hasMoreElements() {
                return iterator.hasNext();
    ...
    public Mono<Response<CopyrightCaption>> getCopyrightCaptionWithResponseAsync(ResponseFormat format) {
        final String accept = "application/json";
        return FluxUtil.withContext(context -> service.getCopyrightCaption(this.client.getHost(), this.client.getClientId(), this.client.getApiVersion(), format, accept, context));
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Mono<Response<CopyrightCaption>> getCopyrightCaptionWithResponseAsync(ResponseFormat format, Context context) {
        final String accept = "application/json";
        return service.getCopyrightCaption(this.client.getHost(), this.client.getClientId(), this.client.getApiVersion(), format, accept, context);
    }
    ...
    public Mono<CopyrightCaption> getCopyrightCaptionAsync(ResponseFormat format) {
        return getCopyrightCaptionWithResponseAsync(format)
            .flatMap((Response<CopyrightCaption> res) -> {
                if (res.getValue() != null) {
                    return Mono.just(res.getValue());
                } else {
                    return Mono.empty();
     ...
     * @param zoom Desired zoom level of the map. Zoom value must be in the range: 0-20 (inclusive). Default value is 12.&lt;br&gt;&lt;br&gt;Please see [Zoom Levels and Tile Grid](https://docs.microsoft.com/en-us/azure/location-based-services/zoom-levels-and-tile-grid) for details.
     ...
     * @param width Width of the resulting image in pixels. Range is 1 to 8192. Default is 512. It shouldn’t be used with bbox.
     * @param language Language in which search results should be returned. Should be one of supported IETF language tags, case insensitive. When data in specified language is not available for a specific field, default language is used.
     * 
     * Please refer to [Supported Languages](https://docs.microsoft.com/azure/azure-maps/supported-languages) for details.
     * @param localizedMapView The View parameter (also called the "user region" parameter) allows you to show the correct maps for a certain country/region for geopolitically disputed regions. Different countries have different views of such regions, and the View parameter allows your application to comply with the view required by the country your application will be serving. By default, the View parameter is set to “Unified” even if you haven’t defined it in  the request. It is your responsibility to determine the location of your users, and then set the View parameter correctly for that location. Alternatively, you have the option to set ‘View=Auto’, which will return the map data based on the IP  address of the request. The View parameter in Azure Maps must be used in compliance with applicable laws, including those  regarding mapping, of the country where maps, images and other data and third party content that you are authorized to  access via Azure Maps is made available. Example: view=IN.
     ...
     * @param path Path style and locations. Use this parameter to optionally add lines, polygons or circles to the image.
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Mono<StreamResponse> getMapStaticImageWithResponseAsync(RasterTileFormat format, StaticMapLayer layer, MapImageStyle style, Integer zoom, List<Double> center, List<Double> boundingBoxPrivate, Integer height, Integer width, String language, LocalizedMapView localizedMapView, List<String> pins, List<String> path) {
        final String accept = "application/json, image/jpeg, image/png, image/pbf, application/vnd.mapbox-vector-tile";
        String centerConverted = JacksonAdapter.createDefaultSerializerAdapter().serializeList(center, CollectionFormat.CSV);
        String boundingBoxPrivateConverted = JacksonAdapter.createDefaultSerializerAdapter().serializeList(boundingBoxPrivate, CollectionFormat.CSV);
        List<String> pinsConverted = Optional.ofNullable(pins).map(Collection::stream).orElseGet(Stream::empty).map((item) -> Objects.toString(item, "")).collect(Collectors.toList());
        List<String> pathConverted = Optional.ofNullable(path).map(Collection::stream).orElseGet(Stream::empty).map((item) -> Objects.toString(item, "")).collect(Collectors.toList());
        return FluxUtil.withContext(context -> service.getMapStaticImage(this.client.getHost(), this.client.getClientId(), this.client.getApiVersion(), format, layer, style, zoom, centerConverted, boundingBoxPrivateConverted, height, width, language, localizedMapView, pinsConverted, pathConverted, accept, context));
    }
    ...
    public Mono<StreamResponse> getMapStaticImageWithResponseAsync(RasterTileFormat format, StaticMapLayer layer, MapImageStyle style, Integer zoom, List<Double> center, List<Double> boundingBoxPrivate, Integer height, Integer width, String language, LocalizedMapView localizedMapView, List<String> pins, List<String> path, Context context) {
        ...
        List<String> pinsConverted = Optional.ofNullable(pins).map(Collection::stream).orElseGet(Stream::empty).map((item) -> Objects.toString(item, "")).collect(Collectors.toList());
        List<String> pathConverted = Optional.ofNullable(path).map(Collection::stream).orElseGet(Stream::empty).map((item) -> Objects.toString(item, "")).collect(Collectors.toList());
        return service.getMapStaticImage(this.client.getHost(), this.client.getClientId(), this.client.getApiVersion(), format, layer, style, zoom, centerConverted, boundingBoxPrivateConverted, height, width, language, localizedMapView, pinsConverted, pathConverted, accept, context);
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Flux<ByteBuffer> getMapStaticImageAsync(RasterTileFormat format, StaticMapLayer layer, MapImageStyle style, Integer zoom, List<Double> center, List<Double> boundingBoxPrivate, Integer height, Integer width, String language, LocalizedMapView localizedMapView, List<String> pins, List<String> path) {
        return getMapStaticImageWithResponseAsync(format, layer, style, zoom, center, boundingBoxPrivate, height, width, language, localizedMapView, pins, path)
            .flatMapMany(StreamResponse::getValue);}
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Flux<ByteBuffer> getMapStaticImageAsync(RasterTileFormat format, StaticMapLayer layer, MapImageStyle style, Integer zoom, List<Double> center, List<Double> boundingBoxPrivate, Integer height, Integer width, String language, LocalizedMapView localizedMapView, List<String> pins, List<String> path, Context context) {
        return getMapStaticImageWithResponseAsync(format, layer, style, zoom, center, boundingBoxPrivate, height, width, language, localizedMapView, pins, path, context)
            .flatMapMany(StreamResponse::getValue);}
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public InputStream getMapStaticImage(RasterTileFormat format, StaticMapLayer layer, MapImageStyle style, Integer zoom, List<Double> center, List<Double> boundingBoxPrivate, Integer height, Integer width, String language, LocalizedMapView localizedMapView, List<String> pins, List<String> path) {
        Iterator<ByteBufferBackedInputStream> iterator = getMapStaticImageAsync(format, layer, style, zoom, center, boundingBoxPrivate, height, width, language, localizedMapView, pins, path).map(ByteBufferBackedInputStream::new).toStream().iterator();
        Enumeration<InputStream> enumeration = new Enumeration<InputStream>() {
            @Override
            public boolean hasMoreElements() {
                return iterator.hasNext();
    ...
    public StreamResponse getMapStaticImageWithResponse(RasterTileFormat format, StaticMapLayer layer, MapImageStyle style, Integer zoom, List<Double> center, List<Double> boundingBoxPrivate, Integer height, Integer width, String language, LocalizedMapView localizedMapView, List<String> pins, List<String> path, Context context) {
        return getMapStaticImageWithResponseAsync(format, layer, style, zoom, center, boundingBoxPrivate, height, width, language, localizedMapView, pins, path, context).block();
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Mono<Response<Copyright>> getCopyrightFromBoundingBoxWithResponseAsync(ResponseFormat format, BoundingBox boundingBox, IncludeText includeText) {
        final String accept = "application/json";
        List<Double> southWest = boundingBox.getSouthWest();
        List<Double> northEast = boundingBox.getNorthEast();
        String southWestConverted = JacksonAdapter.createDefaultSerializerAdapter().serializeList(southWest, CollectionFormat.CSV);
        String northEastConverted = JacksonAdapter.createDefaultSerializerAdapter().serializeList(northEast, CollectionFormat.CSV);
        return FluxUtil.withContext(context -> service.getCopyrightFromBoundingBox(this.client.getHost(), this.client.getClientId(), this.client.getApiVersion(), southWestConverted, northEastConverted, format, includeText, accept, context));
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Mono<Response<Copyright>> getCopyrightFromBoundingBoxWithResponseAsync(ResponseFormat format, BoundingBox boundingBox, IncludeText includeText, Context context) {
        final String accept = "application/json";
        List<Double> southWest = boundingBox.getSouthWest();
        List<Double> northEast = boundingBox.getNorthEast();
        String southWestConverted = JacksonAdapter.createDefaultSerializerAdapter().serializeList(southWest, CollectionFormat.CSV);
        String northEastConverted = JacksonAdapter.createDefaultSerializerAdapter().serializeList(northEast, CollectionFormat.CSV);
        return service.getCopyrightFromBoundingBox(this.client.getHost(), this.client.getClientId(), this.client.getApiVersion(), southWestConverted, northEastConverted, format, includeText, accept, context);
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Mono<Copyright> getCopyrightFromBoundingBoxAsync(ResponseFormat format, BoundingBox boundingBox, IncludeText includeText) {
        return getCopyrightFromBoundingBoxWithResponseAsync(format, boundingBox, includeText)
            .flatMap((Response<Copyright> res) -> {
                if (res.getValue() != null) {
                    return Mono.just(res.getValue());
                } else {
                    return Mono.empty();
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Mono<Copyright> getCopyrightFromBoundingBoxAsync(ResponseFormat format, BoundingBox boundingBox, IncludeText includeText, Context context) {
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Copyright getCopyrightFromBoundingBox(ResponseFormat format, BoundingBox boundingBox, IncludeText includeText) {
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Response<Copyright> getCopyrightFromBoundingBoxWithResponse(ResponseFormat format, BoundingBox boundingBox, IncludeText includeText, Context context) {
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Mono<Response<Copyright>> getCopyrightForTileWithResponseAsync(ResponseFormat format, TileIndex tileIndex, IncludeText includeText) {
        final String accept = "application/json";
        int z = tileIndex.getZ();
        int x = tileIndex.getX();
        int y = tileIndex.getY();
        return FluxUtil.withContext(context -> service.getCopyrightForTile(this.client.getHost(), this.client.getClientId(), this.client.getApiVersion(), z, x, y, format, includeText, accept, context));
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Mono<Response<Copyright>> getCopyrightForTileWithResponseAsync(ResponseFormat format, TileIndex tileIndex, IncludeText includeText, Context context) {
        final String accept = "application/json";
        int z = tileIndex.getZ();
        int x = tileIndex.getX();
        int y = tileIndex.getY();
        return service.getCopyrightForTile(this.client.getHost(), this.client.getClientId(), this.client.getApiVersion(), z, x, y, format, includeText, accept, context);
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Mono<Copyright> getCopyrightForTileAsync(ResponseFormat format, TileIndex tileIndex, IncludeText includeText, Context context) {
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Response<Copyright> getCopyrightForTileWithResponse(ResponseFormat format, TileIndex tileIndex, IncludeText includeText, Context context) {
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Mono<Response<Copyright>> getCopyrightForWorldWithResponseAsync(ResponseFormat format, IncludeText includeText) {
        final String accept = "application/json";
        return FluxUtil.withContext(context -> service.getCopyrightForWorld(this.client.getHost(), this.client.getClientId(), this.client.getApiVersion(), format, includeText, accept, context));
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Mono<Response<Copyright>> getCopyrightForWorldWithResponseAsync(ResponseFormat format, IncludeText includeText, Context context) {
        final String accept = "application/json";
        return service.getCopyrightForWorld(this.client.getHost(), this.client.getClientId(), this.client.getApiVersion(), format, includeText, accept, context);
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Response<Copyright> getCopyrightForWorldWithResponse(ResponseFormat format, IncludeText includeText, Context context) {
