...
/** Resource collection API of Traffics. */
public interface Traffics {
     ...
     */
    TrafficFlowSegmentResult getTrafficFlowSegment(
     ...
     * @return this object is returned from a successful Traffic Flow Segment call.
     */
    Response<TrafficFlowSegmentResult> getTrafficFlowSegmentWithResponse(
        TextFormat format,
     ...
     */
    TrafficIncidentDetailResult getTrafficIncidentDetail(
        TextFormat format,
     ...
     * @return this object is returned from a successful Traffic incident Detail call.
     */
    Response<TrafficIncidentDetailResult> getTrafficIncidentDetailWithResponse(
        TextFormat format,
        TrafficIncidentDetailStyle style,
        String boundingbox,
        int boundingZoom,
     ...
     */
    TrafficIncidentViewportResult getTrafficIncidentViewport(
     ...
     * @return this object is returned from a successful Traffic Incident Viewport call.
     */
    Response<TrafficIncidentViewportResult> getTrafficIncidentViewportWithResponse(
        TextFormat format,
        String boundingbox,
        int boundingzoom,
        String overviewbox,
