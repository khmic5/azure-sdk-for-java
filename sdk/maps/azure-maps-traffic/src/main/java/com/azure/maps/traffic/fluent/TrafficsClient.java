...
package com.azure.maps.traffic.fluent;
...
public interface TrafficsClient {
    /**
    ...
    InputStream getTrafficFlowTile(
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    StreamResponse getTrafficFlowTileWithResponse(
        TileFormat format,
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    TrafficFlowSegmentResultInner getTrafficFlowSegment(
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    Response<TrafficFlowSegmentResultInner> getTrafficFlowSegmentWithResponse(
        TextFormat format,
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    InputStream getTrafficIncidentTile(
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    StreamResponse getTrafficIncidentTileWithResponse(
        TileFormat format,
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    TrafficIncidentDetailResultInner getTrafficIncidentDetail(
        TextFormat format,
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    Response<TrafficIncidentDetailResultInner> getTrafficIncidentDetailWithResponse(
        TextFormat format,
        TrafficIncidentDetailStyle style,
        String boundingbox,
        int boundingZoom,
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    TrafficIncidentViewportResultInner getTrafficIncidentViewport(
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    Response<TrafficIncidentViewportResultInner> getTrafficIncidentViewportWithResponse(
        TextFormat format,
        String boundingbox,
        int boundingzoom,
        String overviewbox,
