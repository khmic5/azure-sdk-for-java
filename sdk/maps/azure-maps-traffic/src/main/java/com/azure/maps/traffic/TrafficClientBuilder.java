...
public final class TrafficClientBuilder {
    ...
    private static final String TRAFFIC_SUBSCRIPTION_KEY = "subscription-key";
    ...
    public TrafficClientBuilder trafficClientId(String trafficClientId) {
        this.trafficClientId = Objects.requireNonNull(trafficClientId, "'ClientId' cannot be null.");;
        return this;
    }
    ...
    private HttpPipeline createHttpPipeline() {
        ...
        if (tokenCredential != null) {
            ...
            policies.add(new AzureKeyCredentialPolicy(TRAFFIC_SUBSCRIPTION_KEY, keyCredential));
        } else {
    ...
    public TrafficAsyncClient buildAsyncClient() {
        ...
        // return new TrafficAsyncClient(buildInnerClient().getTraffics(), this.pipeline);
    }
