...
public final class TrafficClientBuilder {
     ...
     * @return the TrafficClientBuilder.
     */
    public TrafficClientBuilder host(String host) {
        this.host = host;
        return this;
    }
     ...
     * @return the TrafficClientBuilder.
     */
    public TrafficClientBuilder apiVersion(String apiVersion) {
    ...
    private TrafficClientImpl buildInnerClient() {
        ...
        TrafficClientImpl client = new TrafficClientImpl(pipeline, serializerAdapter, xMsClientId, host, apiVersion);
        return client;
    }
    ...
    public TrafficClient buildClient() {
        return new TrafficClient(buildInnerClient().getTraffics());
    }
}
