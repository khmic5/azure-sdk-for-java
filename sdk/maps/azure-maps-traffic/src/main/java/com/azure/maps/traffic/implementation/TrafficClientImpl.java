...
public final class TrafficClientImpl {
     ...
     */
    public TrafficClientImpl(String xMsClientId, Geography geography, String apiVersion) {
        this(
     ...
     * @param apiVersion Api Version.
     */
    public TrafficClientImpl(HttpPipeline httpPipeline, String xMsClientId, Geography geography, String apiVersion) {
