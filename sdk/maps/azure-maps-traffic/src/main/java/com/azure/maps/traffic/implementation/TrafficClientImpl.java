...
/** Initializes a new instance of the TrafficClientImpl type. */
@ServiceClient(builder = TrafficClientBuilder.class)
public final class TrafficClientImpl implements TrafficClient {
    private final ClientLogger logger = new ClientLogger(TrafficClientImpl.class);
    ...
    /** The TrafficsClient object to access its operations. */
    private final TrafficsClient traffics;

    /**
     * Gets the TrafficsClient object to access its operations.
     *
     * @return the TrafficsClient object.
     */
    public TrafficsClient getTraffics() {
    ...
    TrafficClientImpl(
        ...
        this.apiVersion = "1.0";
        this.traffics = new TrafficsClientImpl(this);
    }
