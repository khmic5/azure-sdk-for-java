...
public class JobReleaseTaskExecutionInformation {
    ...
    /**
     * The current state of the Job Release Task on the Compute Node. Possible
    ...
    /**
     * Get the time at which the Job Release Task completed. This property is set only if the Task is in the Completed state.
     *
    ...
    /**
     * Set the time at which the Job Release Task completed. This property is set only if the Task is in the Completed state.
     *
    ...
    /**
     * Get the current state of the Job Release Task on the Compute Node. Possible values include: 'running', 'completed'.
     *
    ...
    /**
     * Set the current state of the Job Release Task on the Compute Node. Possible values include: 'running', 'completed'.
     *
    ...
    /**
     * Get the root directory of the Job Release Task on the Compute Node. You can use this path to retrieve files created by the Task, such as log files.
     *
    ...
    /**
     * Set the root directory of the Job Release Task on the Compute Node. You can use this path to retrieve files created by the Task, such as log files.
     *
    ...
    /**
     * Get the URL to the root directory of the Job Release Task on the Compute Node.
     *
    ...
    /**
     * Set the URL to the root directory of the Job Release Task on the Compute Node.
     *
