...
public class JobPreparationTaskExecutionInformation {
     ...
     * exit code for a process reflects the specific convention implemented by
     * the application developer for that process. If you use the exit code
     ...
     * by the constraints. Task application failures (non-zero exit code) are
     ...
     * started running. This property is set only if the Task was retried (i.e.
    ...
    /**
     * Get the time at which the Task started running. If the Task has been restarted or retried, this is the most recent time at which the Task started running.
     *
    ...
    /**
     * Set the time at which the Task started running. If the Task has been restarted or retried, this is the most recent time at which the Task started running.
     *
    ...
    /**
     * Get the time at which the Job Preparation Task completed. This property is set only if the Task is in the Completed state.
     *
    ...
    /**
     * Set the time at which the Job Preparation Task completed. This property is set only if the Task is in the Completed state.
     *
    ...
    /**
     * Get the current state of the Job Preparation Task on the Compute Node. Possible values include: 'running', 'completed'.
     *
    ...
    /**
     * Set the current state of the Job Preparation Task on the Compute Node. Possible values include: 'running', 'completed'.
     *
    ...
    /**
     * Get the root directory of the Job Preparation Task on the Compute Node. You can use this path to retrieve files created by the Task, such as log files.
     *
    ...
    /**
     * Set the root directory of the Job Preparation Task on the Compute Node. You can use this path to retrieve files created by the Task, such as log files.
     *
    ...
    /**
     * Get the URL to the root directory of the Job Preparation Task on the Compute Node.
     *
    ...
    /**
     * Set the URL to the root directory of the Job Preparation Task on the Compute Node.
     *
    ...
    /**
     * Set the number of times the Task has been retried by the Batch service. Task application failures (non-zero exit code) are retried, pre-processing errors (the Task could not be run) and file upload errors are not retried. The Batch service will retry the Task up to the limit specified by the constraints. Task application failures (non-zero exit code) are retried, pre-processing errors (the Task could not be run) and file upload errors are not retried. The Batch service will retry the Task up to the limit specified by the constraints.
     *
    ...
    /**
     * Set the most recent time at which a retry of the Job Preparation Task started running. This property is set only if the Task was retried (i.e. retryCount is nonzero). If present, this is typically the same as startTime, but may be different if the Task has been restarted for reasons other than retry; for example, if the Compute Node was rebooted during a retry, then the startTime is updated but the lastRetryTime is not.
     *
