...
public class InstanceViewStatus {
    ...
    /**
     * Set the localized label for the status.
     *
    ...
    /**
     * Get level code. Possible values include: 'Error', 'Info', 'Warning'.
     *
    ...
    /**
     * Set level code. Possible values include: 'Error', 'Info', 'Warning'.
     *
    ...
    /**
     * Set the detailed status message.
     *
